<%@ Page Language="vb" AutoEventWireup="false" enableEventValidation="false" Codebehind="Trn.aspx.vb" Inherits="DepartmentPlantCfg.Trn" %>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow CssClass="HideRow">
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="CodeTxt" runat="server" CssClass="UCTxtCls"  Width="200px"
                                    AccessKey="C" TabIndex="1"></asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell CssClass="MainTD" ID="PlantTD"></asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
                                <asp:DropDownList ID="PlantDDL" AutoPostBack="true" runat="server" >
                                </asp:DropDownList>
                                <asp:Label ID="PlantLbl" runat="server" CssClass="HideRow"></asp:Label>
                                <asp:TextBox ID ="PlantTxt" runat ="server" CssClass ="HideRow"></asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell ID="DepartmentTd" ColumnSpan="6" CssClass="SubHeadTd"> </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
