...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ExistingList.aspx.vb" Inherits="Customer.ExistingList" %>
					...
					<ASP:TABLECELL> <!-----------Base table------------->
						<ASP:TABLE id="CrTopTable" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
							...
							<ASP:TABLEROW>
								...
								<ASP:TABLECELL CssClass="MainTD">
									<ASP:TEXTBOX ID="RecPerPageTxt"  MaxLength="4" CssClass="TxtCls" Runat="server" AutoPostBack="False" Width="50px">10</ASP:TEXTBOX>
								</ASP:TABLECELL>
								<ASP:TABLECELL CssClass="MainTD">
									<ASP:LITERAL id="PgNoLtrl" Runat="server"></ASP:LITERAL>
								</ASP:TABLECELL>
								<ASP:TABLECELL CssClass="MainTD">
									<ASP:TEXTBOX id="PgNoTxt" CssClass="TxtCls" Runat="server" AutoPostBack="False" Width="50px" MaxLength="4">1</ASP:TEXTBOX>
								</ASP:TABLECELL>
							</ASP:TABLEROW>
							<ASP:TABLEROW>
							...
							<asp:TableRow>
							  <asp:TableCell Runat=server CssClass="MainTD" ColumnSpan="6" ID="Tablecell1">
							    <%--<asp:Label Runat=server ID="Label1">C:Customer &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</asp:Label> --%>
							    <asp:Label Runat=server ID="Label2">S:Supplier &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</asp:Label>  						
							    <asp:Label Runat=server ID="Label3">M:Manufacturer &nbsp;&nbsp;&nbsp;</asp:Label>   
