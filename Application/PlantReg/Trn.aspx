<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Trn.aspx.vb" Inherits="PlantReg.Trn" %>
						...
						<asp:Table runat="server" CSSClass="SubTable" width="100%" CELLPADDING="0" cellspacing="1"
							...
							<asp:TableRow>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox id="DescTxt" runat="server" CssClass="UCTxtCls" MaxLength="50" Width="200px" AccessKey="D"  TabIndex=1></asp:TextBox>
								</asp:TableCell>
							</asp:TableRow>
							<asp:TableRow>
								<asp:TableCell CssClass="MainTD" ID="CodeTd"></asp:TableCell>
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox id="CodeTxt"  runat="server" CssClass="UCTxtCls" MaxLength="2" Width="200px" AccessKey="C" TabIndex=2 ></asp:TextBox>
								</asp:TableCell>
							</asp:TableRow>
							<asp:TableRow>
								<asp:TableCell CssClass="MainTD" ID="AddressTd" Width="170px"></asp:TableCell>
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox id="AddressTxt" runat="server" CssClass="TxtCls"  onkeypress="taLimit()" onkeyup="taCount()" MaxLength="250" Width="200px" AccessKey="R" TextMode="MultiLine" TabIndex=3></asp:TextBox>
								</asp:TableCell>
							</asp:TableRow>
							<asp:TableRow>
								<asp:TableCell CssClass="MainTD" ID="RemarksIfAnyTd" Width="170px"></asp:TableCell>
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox id="RemarksIfAnyTxt" runat="server" CssClass="TxtCls"  onkeypress="taLimit()" onkeyup="taCount()" MaxLength="250" Width="200px" AccessKey="R" TextMode="MultiLine" TabIndex=4></asp:TextBox>
								</asp:TableCell>
							</asp:TableRow>
