...
//                            break;
     ...
     /* case 24: function to enable/disable 'Reference Permanent Change Control' field
        ...
        //****** Fun Check User Existence and batch recod existence in  Sap
         ...
         // Fun_Check_BatchSelection
                ...
                function Fun_Check_BatchSelection(SrcType)
                {
                    ...
                    if(SrcType ==1) // At  issue Login Approval Cycle
                    {
                      ...
                      BatchAutID='FLD_195_141'
                      BatchSelID='FLD_138_100'
                      ...
                      if (BatchSelObj != null  && BatchAuthObj != null)
                      {
                          ...
                          idStr=BatchAutID
                              ...
                              {
                                  var r = confirm("Decision On Selected Batchs) Is Pending  \n Still To Continue Click Ok ");
                    ...
                    {
                          BatchAutID='1_COL0213008021_141'
                          var BatchAuthObj=document.getElementById(BatchAutID)
                          if (BatchAuthObj != null)
                          {
                              Ajax_CheckACPProsalStatus(document.getElementById("IssueLogIdTXt").value,BatchAutID);
              ...
              function Ajax_CheckACPProsalStatus(IssuelogId,FldID)
              {
                ...
                var url="../PrsWorkFlow/AjaxReadPlanStatus.aspx?IssuelogId=" + IssuelogId  + '&Type=2'
                xmlhttp.open("POST", url, true);
                xmlhttp.send(null);
              }      
