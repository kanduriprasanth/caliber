<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report3.aspx.vb" Inherits="ReportViewer.Report3" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" href="MaskJScript.js" />
    ...
    <script language="javascript" type="text/javascript">
        var MainApplicationURL = 'http://localhost/QAMS300BLM/'
         </script>
   <style type="text/css">
        .body {width:1500px}
        .ReportSubTable
        {
            ...
            border: none;
            mso-border-alt: solid #5fa8cf .5pt;
...
Function fnDateFormat_2(num,unit,mToday)
 
 
 
 dateAry =split(mToday,"/")
 Today=dateSerial(dateAry(2),dateAry(0),dateAry(1))
...
fnDateFormat_2=month(DateStr)  &"/" & day(DateStr) & "/" & year(DateStr)
End Function
...
'fnDateFormat=FormatDateTime(DateStr,2)
fnDateFormat=month(DateStr)  &"/" & day(DateStr) & "/" & year(DateStr)
End Function
...
ValidDate="No"
 ...
 ValidDate=month(DateStr)  &"/" & day(DateStr) & "/" & year(DateStr)
...
End Function
    ...
    <script language="javascript">
        ...
        function fnDisplayDates_2(RowCnt, mToday) {
            ...
            var FromDate = fnDateFormat_2(FromDays, FromUnit, mToday)
            ...
            var ToDate = fnDateFormat_2(ToDays, ToDayUnit, mToday)
        ...
        function ChkDate(RowCnt, PreFix) {
            ...
            if (DateValue == "") {
                alert("Enter Valid Date in 'm/d/yyyy' format")
    ...
    <form id="form1" runat="server">
       ...
       <span style="display: none">
                ...
                <asp:TableCell>
                    <asp:Table ID="CrTopTable" runat="server" HorizontalAlign="center" CellPadding="0"
                        CssClass="SubTable" CellSpacing="1" Width="100%" BackColor="white">
                         <asp:TableRow>
                            <asp:TableCell CssClass="MainTD" ID="TableCell1" runat="server">
                               <asp:Label ID="FilterSHLbl" runat="server" Style="color: Blue; cursor: hand;" CssClass="MainTD"
                                    onclick="fnShowHideFilterTab()"> Show / Hide Filter(s)  </asp:Label>
                            </asp:TableCell>
                         
                           
                        </asp:TableRow>
                        <asp:TableRow ID="FilterTr" runat="server" CssClass="HideRow" >
                         ...
                         <asp:TableRow>
                            <asp:TableCell CssClass="MainTD" ID="TableCell2" runat="server">
                               <asp:Label ID="GroupSHLbl" runat="server" Style="color: Blue; cursor: hand;" CssClass="MainTD"
                                    onclick="fnShowHideGroupTab()"> Show / Hide Group Value(s)  </asp:Label>
                            </asp:TableCell>
                         
                            
                        </asp:TableRow>
                        <asp:TableRow ID="GroupTr2" runat="server"  CssClass="MainTD">
                          ...
                          <asp:TableRow> 
                            <asp:TableCell CssClass="MainTD" ID="TableCell3" runat="server">
                               <asp:Label ID="ChartSHLbl" runat="server" Style="color: Blue; cursor: hand;" CssClass="MainTD"
                                    onclick="fnShowHideChartTab()"> Show / Hide Chart  </asp:Label>
                            </asp:TableCell>
                        ...
                        <asp:TableRow ID="TopChsrDetTr" CssClass="HideRow">
                            <asp:TableCell ID="TopChsrDetTD" CssClass="MainTD" HorizontalAlign="left">
                                <asp:Chart id="Chart1" runat="server" Palette="BrightPastel" ImageType="Png" ImageUrl="~/TempImages/"
                                    BackColor="#D3DFF0" Width="412px" Height="296px" borderlinestyle="Solid" backgradientendcolor="White"
                                ...
                                <input type="button" title='Click here' name="Popup" class="RsnPUP" height="20px"
                                    id="BTN_Chart" onclick="fnOpenChartConfig()">
                                <br />
                                <asp:Label ID="SummaryLbl" runat="server" Style="color: Blue; cursor: hand;" CssClass="MainTD"
                                    onclick="fnShowHideSummaryTab()"> Show / Hide Summary Table </asp:Label>
                            </asp:TableCell>
                        </asp:TableRow>
                        ...
                        <asp:TableRow ID="SummuryTR" CssClass="MainTD" runat="server">
                            <asp:TableCell CssClass="MainTD">
                                <asp:Table ID="SummuryTab" runat="server" HorizontalAlign="left" CellPadding="0"
                                    CssClass="SubTable" CellSpacing="1" Width="700px">
                                </asp:Table>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell CssClass="MainTD">
                                <asp:Table ID="Reocrdtab" CssClass="SubTable" runat="server" Width="700px" BorderColor="black"
                                    ...
                                    <asp:TableRow>
                                        ...
                                        <asp:TableCell BackColor="#fcfffa" HorizontalAlign="Center" CssClass="MainTD">
                                            <asp:Button ID="GoBtn" runat="server" Text="Display" Visible="TRUE"></asp:Button>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </asp:TableCell>
                        ...
                        <asp:TableRow>
                            <asp:TableCell CssClass="MainTD">
                                <asp:Table ID="IssueTab" CssClass="ReportSubTable" runat="server"   BorderWidth="1"
                                    CellPadding="0" CellSpacing="1"   Width=25in >  </asp:Table>
                              
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow ID="BtmChartTr" CssClass="HideRow">
                            <asp:TableCell ID="BtmChrtTd" BackColor="white">
                                <iframe id="BtmChartFrame" runat="server" style="border: none; border: solid 1px black;"
                                    width="700px" height="350px"></iframe>
                            </asp:TableCell>
                        </asp:TableRow>
        ...
        class='ButCls' onmouseout="this.className='ButCls'"   onclick="CancelPrint()"/> 
                                ...
                                <asp:Button ID="Button2" runat="server" Text="Export To PDF" onmouseover="this.className='ButexOCls'"
            class='HideRow' onmouseout="this.className='ButexCls'" />
                                ...
                                <input id="Button3" type="button" value="Export To Excel" onmouseover="this.className='ButexOCls'"
                                    class='ButexCls' onmouseout="this.className='ButexCls'" onclick="ExportToExcel()" />
            ...
            <asp:TableRow CssClass="HideRow" Height="0">
                <asp:TableCell ID="ValidatorsTd">
                    ...
                    <asp:TextBox runat="server" ID="MainReportDrillCntTxt"></asp:TextBox>
                     <asp:TextBox runat="server" ID="SchIdTxt"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
...
<!--
        ...
        function fnReportPage(ReportID, SchID) {
            var UserID = document.getElementById("UserIDTxt").value
            var PlantCode = document.getElementById("PlantCodeTxt").value
            var SchId = document.getElementById("SchIdTxt").value
            window.location = "Report3.aspx?PC=" + PlantCode + "&Uid=" + UserID + "&RptId=" + ReportID + "&SchId=" + SchID
        }
...
<!--
        ...
        function fnDrillDown(DDLCnt, ThisGroupCnt, trendCount, IndexVal, InegrationChk) {
            ...
            if (MainReportID != '') {
                ...
                if (DDLCnt - MainReportDrillCnt < 1) {
                    document.getElementById("form1").action = "Report3.aspx?Uid=" + UserID + "&RptId=" + MainReportID + "&PC=" + PlantCode + "&SchId=" + SchId
                }
            }
            IndexVal = IndexVal * 1
        ...
        function fnGoToDrillDown(g, h, trendCount, InegrationChk) {
            ...
            for (t = 0; t < trendCount; t++) {
                ...
                var Obj = document.getElementById(Trend_LblVal_ID)
                var ObjTdVal = document.getElementById(Trend_TdVal_ID)

                if (Obj != null && ObjTdVal != null) {
...
//-->
    ...
    <script language="javascript">
        ...
        function fnShowHideFilterTab() {
            var FilterTrObj = document.getElementById("FilterTr")
            if (FilterTrObj.className == "MainTD") {
                FilterTrObj.className = "HideRow"
            } else {
                FilterTrObj.className = "MainTD"
            }
        }
        function fnShowHideGroupTab() {
            var GroupTrObj = document.getElementById("GroupTr2")
            if (GroupTrObj.className == "MainTD") {
                GroupTrObj.className = "HideRow"
            } else {
                GroupTrObj.className = "MainTD"
            }
        }
        function fnShowHideChartTab() {
            var TrObj = document.getElementById("TopChsrDetTr")
            if (TrObj.className == "MainTD") {
                TrObj.className = "HideRow"
            } else {
                TrObj.className = "MainTD"
            }
        }

        function fnHidleAllSHLbe() {
            //ChartSHLbl FilterSHLbl GroupSHLbl
            var ChartSHLblObj = document.getElementById("ChartSHLbl")
            var GroupSHLblObj = document.getElementById("GroupSHLbl")



            var FilterSHLblObj = document.getElementById("FilterSHLbl")
            // FilterSHLblObj.className = "HideRow"
            if (document.getElementById("TopChsrDetTr").className == "HideRow") {
                ChartSHLblObj.className = "HideRow"
                GroupSHLblObj.className = "HideRow"
            }



        }
        //   fnShowHideSummaryTab()
        fnShowHideFilterTab()
        // fnShowHideGroupTab()
        fnHidleAllSHLbe()
    ...
    <script language="javascript">
        ...
        function ExportToExcel() {
            ...
            var table = $("#IssueTab").html();
            var ColmnNos = "";

            //            for (r = 2; r <= colCount; r++) {
            ...
            //                }
            //            }
            //            $("#IssueTab :checkbox").remove();

            var NotAllowedColumns = new Array();
            NotAllowedColumns = ColmnNos.split(",");
            //NotAllowedColumns.sort();

            var CurrntColCnt = 0
            for (r = 0; r < NotAllowedColumns.length; r++) {
                $("#IssueTab tr > :nth-child(" + (NotAllowedColumns[r] - CurrntColCnt) + ") ").remove();
                CurrntColCnt = CurrntColCnt + 1;
            }
            ...
            HideMask();
            //oSheet.autofit;
            oBook.WorkSheets(1).Protect("caliber_TAG")


            var ExcelFilePath = CaliberDocumentViewerIns.ReadFileDialogPath();
            if (ExcelFilePath != "") {
                oBook.SaveAs(ExcelFilePath, 51); //51 -xlOpenXMLWorkbook save file format type
            }
            CaliberDocumentViewerIns.CloseControl();
            // alert("Please Change Save As Type From 'Web Page' To 'Excel Workbook' Before Saving")
        ...
        function ExportToPDF() {
            ...
            CaliberDocumentViewerIns.LoadDocument(BDataPath, true);
    ...
    <script language="javascript">
        ...
        //                $("#IssueTab tr > :nth-child(" + (r + 1) + ") ").first().each(function () {
        //                    $(this).append('&nbsp;&nbsp;<input type="checkbox" id="Chk' + (r + 1) + '" ');
        //                });
        //            }
