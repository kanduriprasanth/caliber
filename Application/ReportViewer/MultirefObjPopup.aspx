<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MultirefObjPopup.aspx.vb" Inherits="ReportViewer.MultirefObjPopup" %>
							...
							<table width="100%" cellSpacing="0" cellPadding="0" align="center">
								...
								<tr class="MainTD">
									...
									<td class="MainTd" colspan="2">
										...
										<asp:Button id="btnFind" runat="server" Text="Display" ></asp:Button>
									</td>
								</tr	<tr class="MainTD"> <td class="MainTd" colspan="4">
