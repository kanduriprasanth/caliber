<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UserGrpPopUp.aspx.vb" Inherits="EscalationNodeConfig.UserGrpPopUp" %>
...
//           else   
//             {
                opener.fnCrSetToCode(RevAppIdVal,RevAppCodeVal,RevAppUCodeVal,RevAppDesc)        //RevAppUCodeVal     
                document.getElementById("RBVal").value = RevAppIdVal
             //}   
