<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Config.aspx.vb" Inherits="EscalationNodeConfig.Config" %>
					...
					<asp:TableCell>
						...
						<asp:Table runat="server" CSSClass="SubTable" width="100%" CELLPADDING="0" cellspacing="1"
							...
							<asp:TableRow>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:dropdownlist id="NARAtCreat" runat="server" Width="50px"  Enabled="false">
								...
								<asp:TableCell CssClass="MainTD">
									<asp:dropdownlist id="NARAtStatusChange" runat="server" Width="50px"  Enabled="false">
										<asp:ListItem Value="0" Selected="True">0</asp:ListItem>
										<asp:ListItem Value="1">1</asp:ListItem>
										<asp:ListItem Value="2">2</asp:ListItem>
										<asp:ListItem Value="3">3</asp:ListItem>
