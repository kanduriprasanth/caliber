<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DptUserGrpPopUP.aspx.vb" Inherits="EscalationNodeConfig.DptUserGrpPopUP" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
    ...
    <script language="javascript">
  	...
  	function fnCrGetCode(RowCnt,OpenerRowCnt)
	{ 	
		    ...
		    var RevAppdDesc=document.getElementById("RevAppDes"+ RowCnt).innerHTML
//		    
...
//           else   
//             {
                opener.fnCrDeptUgpSetToCode(RevAppIdVal,RevAppCodeVal,RevAppUCodeVal,RevAppdDesc,OpenerRowCnt)        //RevAppUCodeVal     
                document.getElementById("RBVal").value = RevAppIdVal
             //}   
		   	
	}
	function fnCrCancel(){
		opener.fnCrDeptUgpSetToCode('','','','',<%=request.QueryString("RowCnt") %>)
		window.self.close()
	}
