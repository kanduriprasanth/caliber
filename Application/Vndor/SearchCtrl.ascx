    ...
    <tr>
        <td class="SubHeadTD" colspan="2" align="left">
            ...
            <select id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
                ...
                <option value="1">Vendor Code</option>
    ...
    <tr class="HideRow" id="SrchTr2">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                        Vendor Name Like &nbsp;<input class="TxtCls" id="SrchTxt2" style="width: 200px" accesskey="D"
                            type="text" maxlength="270" value="%" name="SrchTxt2"></td>
                </tr>
            </table>
        </td>
    </tr>
    <tr class="HideRow" id="SrchTr1">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                        &nbsp;Vendor Code =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls" id="SrchTxt1"
                            style="width: 200px" accesskey="D" type="text" maxlength="250" name="SrchTxt1"></td>
                </tr>
            </table>
        </td>
    </tr>
