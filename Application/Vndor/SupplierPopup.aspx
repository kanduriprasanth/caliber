<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SupplierPopup.aspx.vb" Inherits="Vndor.SupplierPopup" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Vendor List Popup</title>
							...
							<table width="100%" cellSpacing="0" cellPadding="0" align="center">
								...
								<tr>
									<td class="MainTd" colspan="2">
										...
										<asp:TextBox id="FindTxt" runat="server" Width="125px" MaxLength="20" CssClass='TxtCls'>%</asp:TextBox>
									</td>
									<td class="MainTd" colspan="2">
										<b><asp:literal id="FetchSizeLtrl" runat="server">Records Limit</asp:literal></b>
										<asp:textbox id="FetchSizeTxt" runat="server" Width="35px" CssClass="TxtCls" MaxLength="3" >50</asp:textbox>
    ...
    var RowCnt
    var KdIdVal
 	function fnCrGetCodeTemp(Cnt){
        RowCnt = Cnt
        KdIdVal=document.all("KdId"+ RowCnt).innerText
        document.getElementById("RBVal").value=KdIdVal
	}
  	function fnCrGetCode(RowCnt)
	{
		    var KfLableVal=document.all("KfLable"+ RowCnt).innerHTML
		    var CodeLableVal = document.all("CodeLable"+ RowCnt).innerHTML
		    var IsSrvcePr=document.all("IsSrvcePr"+ RowCnt).innerText
		   	opener.fnCrSuppSetToCode(KdIdVal,KfLableVal, CodeLableVal, IsSrvcePr)
	}
	function fnCrCancel(){
		opener.fnCrSuppSetToCode('','','','')
		window.self.close()
	}
