<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AuditDetails.aspx.vb" Inherits="SAPBATSTS.AuditDetails" %>


<html>
<head>
    <title>User Mapping Audit</title>
            ...
            <asp:TableRow>
                <asp:TableCell CssClass="MainFoot">
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="0"
                        ...
                        <asp:TableRow>
                            <asp:TableCell CssClass="MainFoot">
									<input type="button" onMouseOver="this.className='ButOCls'" Class='HideRow' accessKey="C"
										onMouseOut="this.className='ButCls'" Value='Back' onclick='window.history.back()' >
                            </asp:TableCell>
