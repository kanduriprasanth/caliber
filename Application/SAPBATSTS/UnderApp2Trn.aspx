<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UnderApp2Trn.aspx.vb" Inherits="SAPBATSTS.UnderApp2Trn" %>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                       ...
                       <asp:TableRow>
                        ...
                        --%>
                         ...
                         <asp:TableRow>
                            <asp:TableCell CssClass="MainTD" ID="TableCell5">Approved(1) By </asp:TableCell>
                            <asp:TableCell CssClass="MainTD"  >
                                <asp:Label ID="App1ByLbl" runat="server" Text=""></asp:Label> 
                                <asp:TextBox ID="App1ByTxt" runat="server" CssClass="HideRow" MaxLength="30" Width="200px"
                                    AccessKey="C" TabIndex="3"></asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        
                        <asp:TableRow>
                            <asp:TableCell CssClass="MainTD" ID="TableCell6">Approved(1) On </asp:TableCell>
                            <asp:TableCell CssClass="MainTD"  >
                                <asp:Label ID="Appon1Lbl" runat="server" Text=""></asp:Label> 
                                <asp:TextBox ID="Appon1Txt" runat="server" CssClass="HideRow" MaxLength="30" Width="200px"
                                    AccessKey="C" TabIndex="3"></asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        
                        <asp:TableRow>
                            <asp:TableCell CssClass="MainTD" ID="TableCell7">Approved(1) Status </asp:TableCell>
                            <asp:TableCell CssClass="MainTD"  >
                                <asp:Label ID="App1StsLbl" runat="server" Text=""></asp:Label> 
                                <asp:TextBox ID="App1StsTxt" runat="server" CssClass="HideRow" MaxLength="30" Width="200px"
                                    AccessKey="C" TabIndex="3"></asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        
                         <asp:TableRow>
                            <asp:TableCell CssClass="MainTD" ID="TableCell8">Approved(1) Remarks </asp:TableCell>
                            <asp:TableCell CssClass="MainTD"  >
                                <asp:Label ID="App1RemLbl" runat="server" Text=""></asp:Label> 
                                <asp:TextBox ID="App1RemTxt" runat="server" CssClass="HideRow" MaxLength="30" Width="200px"
                                    AccessKey="C" TabIndex="3"></asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
