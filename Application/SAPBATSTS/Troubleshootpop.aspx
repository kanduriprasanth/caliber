<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Troubleshootpop.aspx.vb" Inherits="SAPBATSTS.Troubleshootpop" %>
...
<body>
    ...
    <div>
     <ASP:TABLE id="Table" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
					...
					<ASP:TableRow runat ="server" CssClass ="MainHead"> 
					<ASP:TableCell  Text ="SAP-Upload Status"></ASP:TableCell>
					</ASP:TableRow>
							...
							cellspacing="1" width="100%">   
									<ASP:TableRow CssClass ="MainFoot">
									    <ASP:TableCell CssClass ="MainFoot">
                                             ...
                                             <asp:Button ID="Confirm" runat ="server" Text="OK" CssClass ="HideRow" />
									    </ASP:TableCell>
									</ASP:TableRow>				
							</ASP:TABLE>  
					    </ASP:TableCell>
