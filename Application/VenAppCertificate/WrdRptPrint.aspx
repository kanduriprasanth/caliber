<%@ Page Language="vb" AutoEventWireup="false" Codebehind="WrdRptPrint.aspx.vb" Inherits="VenAppCertificate.WrdRptPrint" %>
...
<%@ Register TagPrefix="uc11" TagName="PrintControl" Src="../VenAppCertificate/PrintControl.ascx" %>
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Table ID="HeaderTab" runat="server" HorizontalAlign="center" BorderWidth="0"
                       ...
                       Certificate of Vendor Qualification
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                </asp:TableCell>
...
<%--                    <asp:Table ID="PrntDet" runat="server" HorizontalAlign="center"
                        BorderWidth="0" CellPadding="0" CellSpacing="1" Width="99.3%">
                        <asp:TableRow>
                            <asp:TableCell Font-Bold="true" HorizontalAlign=Justify Width="25%" >Prepared by
                            </asp:TableCell>
                            <asp:TableCell Font-Bold="true" HorizontalAlign=Justify Width="75%" >Approved On
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell Font-Bold="true">Name: Admin
                            </asp:TableCell>
                            <asp:TableCell Font-Bold="true" HorizontalAlign="left">Name: Admin1
                            </asp:TableCell>
                        ...
                        <asp:TableRow>
                            <asp:TableCell Font-Bold="true">Date: june5
                            </asp:TableCell>
                            <asp:TableCell Font-Bold="true" HorizontalAlign="left">Date:june5
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>--%>
                            </asp:TableCell>
...
//                var WrdFilePath = TempPath + "\efdfDocLogin" + i + ".doc";
                ...
                var PdfFilePath = HelloWorldControl1Ins.GetTempPath() + "VenQualificationCer.pdf";
                HelloWorldControl1Ins.ExportDocumentToPDF(PdfFilePath)
...
//        var BodyData = WordFormatCorrections(BodyDataArr.join(""););
        ...
        var FileName = "Vendor Qualification Certificate";
