...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AppList.aspx.vb" Inherits="VenAppCertificate.AppList" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="RecPerPageTxt" MaxLength="4" runat="server" Width="30px" CssClass="TxtCls"
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="PgNoTxt" runat="server" Width="50px" MaxLength="4" CssClass="TxtCls"
