<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreationList.aspx.vb"
    Inherits="VenAppCertificate.CreationList" %>
...
<!--
 ...
 function fnOpenCrPopUp(){
	...
	var features = "height=450,width=600,toolbar=no,resizable=no,menubar=no,status=no,scrollbars=auto,top=250,left=150"
	SpWinObj = window.open(pageURL,'SpecCodes',features)
	if(SpWinObj.opener == null) SpWinObj.opener=self;
	SpWinObj.focus();
}
function fnCrSetToCode(KfIdVal,KfLableVal,ItemIdVal){
      var objId
      var obj
                                ...
                                <table align="center" cellpadding="0" class="SubTable" cellspacing="1" width="100%">
                                    ...
                                    <tr>
                                        <td colspan="2" class="HideRow">
                                            ...
                                            <asp:TextBox ID="ItemIdsTxt" runat="server" Height="0" Width="0" CssClass="HideRow" AutoPostBack="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
