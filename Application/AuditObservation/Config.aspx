<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Config.aspx.vb" Inherits="AuditObservation.Config" %>
					...
					<asp:TableCell>
						...
						<asp:Table runat="server" CSSClass="SubTable" width="100%" CELLPADDING="0" cellspacing="1"
							...
							<asp:TableRow>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:dropdownlist id="NARAtCreat" runat="server" Enabled = "False" Width="50px">      <%--Enable = False is removed by P Suresh--%>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:dropdownlist id="NARAtModify" runat="server" Enabled = "False" Width="50px">     <%--Enable = False is removed by P Suresh--%>
										<asp:ListItem Value="0">0</asp:ListItem>
										<asp:ListItem Value="1">1</asp:ListItem>
										<asp:ListItem Value="2">2</asp:ListItem>
										<asp:ListItem Value="3">3</asp:ListItem>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:dropdownlist id="NARAtStatusChange" runat="server" Enabled = "False" Width="50px">  
										<asp:ListItem Value="0">0</asp:ListItem>
										<asp:ListItem Value="1">1</asp:ListItem>
										<asp:ListItem Value="2">2</asp:ListItem>
										<asp:ListItem Value="3">3</asp:ListItem>
