...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl3.ascx.vb" Inherits="AuditObservation.SearchCtrl3" %>
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
			<option value="0" selected>Top 250 Records</option>
				<option value="2"> Audit Description </option>
			    <option value="1"> Audit Observation Code</option>
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
						<td class="MainTD">&nbsp;Audit Observation Code Like
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Audit Description Like &nbsp;<input class="TxtCls" id="SrchTxt2" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
	...
	<tr class="HideRow" id="SrchTr4">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				...
				<tr>
					<td class="MainTD">
						Vendor Like&nbsp;&nbsp;&nbsp;<input class="TxtCls" id="SrchTxt3" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
	...
	<tr class="HideRow" id="SrchTr5">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				...
				<tr>
					<td class="MainTD">
						Item/Service Like&nbsp;&nbsp;&nbsp;<input class="TxtCls" id="SrchTxt4" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
