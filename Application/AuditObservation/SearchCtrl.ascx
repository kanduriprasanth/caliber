<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl.ascx.vb" Inherits="AuditObservation.SearchCtrl" %>
...
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr class="HideRow" id="SrchTr1">   <%----Edited by P Suresh--%>             
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Audit Observation Code Like &nbsp;<input class="TxtCls" id="SrchTxt1" style="WIDTH: 200px" accessKey="D" type="text" maxLength="50"
...
<%--	<tr class="HideRow" id="SrchTr1">           
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;Audit Observation Code 
	...
	<tr class="HideRow">
		<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SearchCtrl1<%=UniqeIDSep%>FromDate<%=UniqeIDSep%>CalDateVal,SearchCtrl1<%=UniqeIDSep%>ToDate<%=UniqeIDSep%>CalDateVal" name="SrchObjIds">	<%----Edited by P Suresh--%>
...
function DisplayFilterTab(){
  ...
  if(SelSearcType>0){
   ...
   document.all(ObjId).className="MainTd" 
  }//if
}//DisplayFilterTab

function HideAllSrchTypes(){                        //<%----Edited by P Suresh--%>
