<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProposalDet.aspx.vb" Inherits="AuditObservation.ProposalDet" %>
...
<HTML>
	...
	function FnExstDetpopup(DId,PId)
	 {
	    SetPopDimensions()    
	    var features = "height="+ 650 + ",width=" + 950 + ",toolbar=no,resizable=no,menubar=no,status=no,scrollbars=yes,top=" + PopUpLeftTopY +  ",left=" + PopUpLeftTopX
    	 
	    var pageURL = "ViewExstDet.aspx?DeptId=" + DId + "&ProcessId=" + PId
     ...
     function FnStatusPopUp(BaseId,DptId,PrcsId,ChklstId)
	 {
	    SetPopDimensions()    
	    var features = "height="+ 600 + ",width=" + 780 + ",toolbar=no,resizable=no,menubar=no,status=no,scrollbars=yes,top=" + PopUpLeftTopY +  ",left=" + PopUpLeftTopX
    	 
	    var pageURL = "StatusPopUp.aspx?BaseId=" + BaseId + "&DptId=" + DptId + "&PrcsId=" + PrcsId + "&ChklstId=" + ChklstId ;
			...
			<asp:table id="tt" CELLPADDING="0" CELLSPACING="0" BorderWidth="3" HorizontalAlign="center"
				...
				<asp:TableRow Height="20">
					<asp:TableCell CssClass="MainHead">
						<asp:Literal ID="MainTitleLtrl" Runat="server">Audit Observation</asp:Literal>
					</asp:TableCell>
				</asp:TableRow>
				<asp:TableRow>
					<asp:TableCell>
						...
						<asp:Table runat="server" CSSClass="SubTable" width="100%" CELLPADDING="0" cellspacing="1"
							...
							<asp:TableRow ID="HdrCodeRw" CssClass="HideRow">
								<asp:TableCell CssClass="MainTD" ID="HdrCodeTd" Width="40%">Audit Header Code</asp:TableCell>
								<asp:TableCell CssClass="MainTD" >
							...
							<asp:TableRow ID="AdtTypeRw" >
								<asp:TableCell CssClass="MainTD" ID="TableCell3"  Width="20%">Audit Type</asp:TableCell>
								<asp:TableCell CssClass="MainTD" ID="TableCell5">
								</asp:TableCell>
							</asp:TableRow>
							
							<asp:TableRow >
								<asp:TableCell CssClass="MainTD" ID="DescTd"  Width="20%">Audit Description</asp:TableCell>
                           ...
                           <asp:TableRow ID="RegRw" CssClass="HideRow">
							...
							<asp:TableRow ID="VendRw" CssClass="HideRow">
								<asp:TableCell CssClass="MainTD" ID="TableCell2">Vendor</asp:TableCell>
								<asp:TableCell CssClass="MainTD" ID="VendValTd">
								</asp:TableCell>
							</asp:TableRow>
														
							<asp:TableRow ID="ItemRw" CssClass="HideRow">
								<asp:TableCell CssClass="MainTD" ID="TableCell4">Item(s)</asp:TableCell>
							...
							<asp:TableRow>
							    ...
							    <asp:TableCell id="FileAttchTD1" CssClass="MainTD"></asp:TableCell>
                            </asp:TableRow> 
							
							<asp:TableRow CssClass="HideRow">
								<asp:TableCell CssClass="MainTD" ID="TableCell1">Remark(s)/Reason(s)</asp:TableCell>
								<asp:TableCell CssClass="MainTD" ID="DevTD">
								</asp:TableCell>
							</asp:TableRow>
							...
							<asp:TableRow id="OthTr" CssClass="HideRow" >								
								<asp:TableCell ID="OthTd" CssClass="MainTD" columnspan=2>
								</asp:TableCell>
							</asp:TableRow>
