<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IssueStatus.aspx.vb" Inherits="IssueTypeConfig.IssueStatus" %>
...
<script language="javascript">
	...
	function VbChkDates 
     ...
     EndDate=document.getElementById("EndDtCal:CalDateVal").value
	...
	<form id="Form1" method="post" runat="server">
			<asp:table id="tt" runat="server" Width="900px" CELLPADDING="1" CELLSPACING="1" BorderWidth="3"
				...
				<asp:TableRow>
                       ...
                       <asp:Panel id="Panel1"  runat="server" Width="100%" HorizontalAlign="Left"  EnableViewState="False">
					   <uc3:ReportHeader id="ReportHeader1" runat="server"></uc3:ReportHeader>
		         		</asp:Panel>
                        </asp:TableCell>
                        </asp:TableRow>
				<asp:TableRow CssClass="MainTD">
					<asp:TableCell CssClass="MainTD" ColumnSpan="2" ID="StartDtTd"></asp:TableCell>
					<asp:TableCell CssClass="MainTD" ColumnSpan="1">
						<uc1:CaliberCalender id="StartDtCal" runat="server"></uc1:CaliberCalender>
					</asp:TableCell>
					<asp:TableCell CssClass="MainTD" ColumnSpan="2" ID="EndDtTd"></asp:TableCell>
					<asp:TableCell CssClass="MainTD" ColumnSpan="2">
						<uc1:CaliberCalender id="EndDtCal" runat="server"></uc1:CaliberCalender>
					</asp:TableCell>
				</asp:TableRow>
			 ...
			 <asp:TableRow>
                <asp:TableCell CssClass="MainFoot" ColumnSpan="7">
				...
				<asp:TableRow>
					<asp:TableCell ColumnSpan="6" CssClass="HideRow">
			...
			<div style="DISPLAY: block"><asp:panel id="HeaderDiv" style="BORDER-RIGHT: black thin solid; BORDER-TOP: black thin solid; MARGIN-LEFT: 20px; BORDER-LEFT: black thin solid; BORDER-BOTTOM: black thin solid; TEXT-ALIGN: left"
					...
					runat="server" Width="720" CssClass="HideRow">
					<asp:textbox id="BodyObjIDs" style="VISIBILITY: hidden" runat="server" width="0" height="0" text="ColValTab"></asp:textbox>
