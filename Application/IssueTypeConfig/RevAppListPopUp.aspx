<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RevAppListPopUp.aspx.vb"
    Inherits="IssueTypeConfig.RevAppListPopUp" %>
...
<head>
    ...
    <script language="javascript">
        function UserGroupDetails(UserGroupId)
        {
            ...
            SpWinObj = window.open(pageURL,'TemplatePreview',"height=300,width=600,toolbar=no,resizable=false,menubar=no,status=no,scrollbars=yes,top=75,left=75");
