<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MsgDisplay1.aspx.vb" Inherits="IssueTypeConfig.MsgDisplay1" %>
        ...
        <table class="maintable" id="Table1" cellspacing="0" style="height: 150px; width: 520px"
            ...
            <tr class="MainHead">
                <td align="left" colspan="4">
                    &nbsp;<asp:Label ID="Label1" runat="server" Font-Names="Verdana" Font-Size="15px"
                        ForeColor="black">&nbsp;Caliber LIMS</asp:Label>&nbsp;<asp:Label ID="Label2" runat="server"
            ...
            <tr height="25" class="MainFoot">
                <td class="maintd1" colspan="4">
                    <div align="left">
                        &nbsp;&nbsp;
                        <input type="button" id="Back1"  value="  Home   " class="butcls">
                        <input type="button" id="Button1"  value="  Next   " class="butcls">
                        </div>
                </td>
            </tr>
        </table>
