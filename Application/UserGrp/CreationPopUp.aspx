<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreationPopUp.aspx.vb" Inherits="UserGrp.CreationPopUp" %>
	...
	<body MS_POSITIONING="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
		<form id="Form1" method="post" runat="server">
			<TABLE class="MainTable" height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center"
				...
				<!-- MAIN HEADER -->
				<TR>
					<TD class="MainHead">Department List</TD>
				</TR>
				<TR>
					<TD>
				...
				<!-- MAIN FOOTER -->
				<TR>
					<TD class="MainFoot"><INPUT class="ButCls" onmouseover="this.className='ButOCls'" style="WIDTH: 50px" onclick="fnSpCloseWin()"
 ...
 var Count=''
  var flag=false
	...
	Count=RowCnt
		     ...
		     var KfLableVal=document.all("KfLable_"+ RowCnt).innerHTML
		    var KdIdVal=document.all("KdId"+ RowCnt).innerText
		    var KfDescVal=document.all("KfLable"+ RowCnt).innerText
		   	opener.fnCrSetToCode(KdIdVal,KfLableVal,KfDescVal)
		   	 flag=true
		   	  document.getElementById("RBVal").value = KfLableVal
	}
	function fnCrCancel(){
