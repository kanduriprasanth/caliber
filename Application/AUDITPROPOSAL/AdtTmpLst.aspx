<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdtTmpLst.aspx.vb" Inherits="AUDITPROPOSAL.AdtTmpLst" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
    ...
    for(var k=0;k<<%=RecordCnt%>;k++)
    {
        ...
        opener.fnGetFormVal(KdIdVal,KdCodeVal,KfLableVal)
    }
	...
	{ 
		...
		var KdDes=document.all("KdDes"+ RowCnt).innerText
		document.getElementById("RBVal").value = KdIdVal
		
		opener.fnGetSchFormVal(KdIdVal,KdCodeVal,KfLableVal,KdDes)
	}
