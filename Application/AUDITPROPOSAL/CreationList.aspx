<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreationList.aspx.vb" Inherits="AUDITPROPOSAL.CreationList" %>
									...
									<TABLE Align="center" CELLPADDING="0" class="SubTable" cellspacing="1" width="100%">
										<tr>
											<td Style="WIDTH:200px" class="MainTd">
												Audit Template Name &nbsp; <INPUT type="button" onclick="fnOpenCrPopUp()" class='RsnPUP' style="HEIGHT:20px" title="Click Here">
											</td>
											<td class="MainTd">
