<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ShowAudit.aspx.vb" Inherits="AUDITPROPOSAL.ShowAudit" %>
        ...
        <asp:Table ID="tt" CellPadding="0" CellSpacing="0" BorderWidth="3" HorizontalAlign="center"
            ...
            <asp:TableRow Height="20">
                <asp:TableCell CssClass="MainHead">
                    <asp:Literal ID="MainTitleLtrl" runat="server">Audit Proposal</asp:Literal>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow>
                            <asp:TableCell CssClass="SubHead">
                                <asp:Literal ID="SubTitleLtrl" runat="server">Audit Proposal Details</asp:Literal>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell CssClass="SubHead">
