<%@ Control Language="vb" AutoEventWireup="false" Codebehind="EsignObj1.ascx.vb" Inherits="AUDITPROPOSAL.EsignObj1" %>
...
AppAction='Re-test';
 ...
 function fnCallESign(RgsChildId,Cnt,Type,Value,Remark,Title){	
...
function fnActivity(){
	...
	var ScreenTitle=ObjPrefix1//document.forms(0).all(ScreenTitleId).value
