<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ChckListPopUp.aspx.vb" Inherits="AUDITPROPOSAL.ChckListPopUp" %>
	 ...
	 pageURL ="TemplatePreview.aspx?TemplateId=" + TemplateId
	  SpWinObj = window.open(pageURL,'TemplatePreview',"height=350,width=600,toolbar=no,resizable=yes,menubar=no,status=no,scrollbars=yes,top=75,left=75");
        ...
        SpWinObj.focus();
        	...
        	function OpenChklistDet(BaseId) 
    {
		var yval = parseInt(screen.availHeight) - 100  
		var xval = screen.availWidth-500
 
		var pageURL ="ChkListParticulars.aspx?BaseId="+BaseId 
                ...
                <td>
                    <div class="MainTd" style="height: 20px" id="Div1">
                        <table width="100%" cellspacing="0" cellpadding="0" align="center">
                            ...
                            <tr class="HideRow">
                                <td>
                                    <asp:TextBox ID="RBVal" runat="server" Width="50px" CssClass="TxtCls"></asp:TextBox>
                                </td>
                                <td>
                                </td>
                            </tr>
...
//        var PrcsCnt=<%=PrcsCnt%>
//              
//        opener.fnGetCheckListVal(KdIdVal,KdCodeVal,KfLableVal,DeptCnt,PrcsCnt)
//    }
	
	function fnCrCancel(){
	    var DeptCnt=<%=DeptCnt%>
        var PrcsCnt=<%=PrcsCnt%>
		opener.fnGetCheckListVal('','','',DeptCnt,PrcsCnt)
		window.self.close()
	}
