<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Trn.aspx.vb" Inherits="RegulatoryAgency.Trn" %>
				...
				<asp:TableRow>
					<asp:TableCell>
						...
						<asp:Table runat="server" CSSClass="SubTable" width="100%" CELLPADDING="0" cellspacing="1"
							...
							<asp:TableRow>
								<asp:TableCell CssClass="MainTD" ID="NameTD" ></asp:TableCell>
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox id="NameTxt" runat="server" CssClass="TxtCls" MaxLength="250" Width="200px" AccessKey="D"  TabIndex=2></asp:TextBox>
								</asp:TableCell>
							</asp:TableRow>
							...
							<asp:TableRow>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox id="DescTxt" runat="server" CssClass="TxtCls" TextMode="MultiLine" onkeypress="taLimit()" onkeyup="taCount()" MaxLength="250" Width="200px" AccessKey="D"  TabIndex=3></asp:TextBox>
								</asp:TableCell>
							</asp:TableRow>
