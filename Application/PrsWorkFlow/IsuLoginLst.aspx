<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IsuLoginLst.aspx.vb" Inherits="PrsWorkFlow.IsuLoginLst" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
						...
						<ASP:TABLE id="CrTopTable" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
							...
							<ASP:TABLEROW>
								<ASP:TABLECELL ColumnSpan="6">
									<ASP:TABLE id="IssAuditTable" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
		...
		function RasiSeAlert()
		{
		  if ("<%=MsgStr%>"  != "")
		  {		  
		      alert( "<%=MsgStr%>" )
		      window.navigate("../CAPAWORKS/QAActivites.aspx?imageId=" + <%=Request.QueryString("imageId") %> +" &PrsId=" + <%=ProcessType%>)
		  }
		}
