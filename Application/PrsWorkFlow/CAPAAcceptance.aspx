<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CAPAAcceptance.aspx.vb" Inherits="PrsWorkFlow.CAPAAcceptance" %>
...
//     }
     ...
     function funPlanProsAcp(RowCnt)
     {
       ...
       if (ExpMsg == "")
       {
         ...
         //AjaxModifyActPlan(RowCnt,AceptStatus)
       }
       else
       { alert(ExpMsg); return;}
     }
            ...
            if(reqXML)
            {
                ...
                reqXML.onreadystatechange = function()
                {
                    if(reqXML.readyState==4)
                    {
                        ...
                        {
//                            if (AceptStatus ==true)
//                                { alert("Action Plan Proposal Is-Accepted ") }
//                                
//                            else if (AceptStatus ==false)
