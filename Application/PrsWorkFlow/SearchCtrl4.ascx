<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SearchCtrl4.ascx.vb" Inherits="PrsWorkFlow.SearchCtrl4" %>
    ...
    <tr>
        <td class="SubHeadTD" colspan="2" align="left">
            ...
            <select id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
                ...
                <option value="2">   <%=HttpContext.Current.Application("QAMS297_" & "0")%>  </option>
                <option value="4">   <%=HttpContext.Current.Application("QAMS299_" & "0")%>  </option>
    ...
    <tr class="HideRow" id="SrchTr2">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                border="0">
                <tr>
                   <td class="MainTD"><%=Application("QAMS297_" & "0")%> Like &nbsp;<input class="TxtCls" id="SrchTxt2" maxLength="25"  style="WIDTH: 200px" accessKey="D" type="text"
    ...
    <tr class="HideRow" id="SrchTr1">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                        &nbsp;  <%=HttpContext.Current.Application("ISSU007_" & "0")%> 
                        Like &nbsp;<input class="TxtCls" id="SrchTxt1" style="width: 200px"
                            accesskey="D" type="text" value="%" maxlength="30" name="SrchTxt1"></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    ...
                    <td class="MainTD">
                        &nbsp;  <%=HttpContext.Current.Application("QAMS299_" & "0")%> 
                        Like &nbsp;<input class="TxtCls" id="SrchTxt4" style="width: 200px"
                            accesskey="D" type="text" value="%" maxlength="30" name="SrchTxt4"></td>
