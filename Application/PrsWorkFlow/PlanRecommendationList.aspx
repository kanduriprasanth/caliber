<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PlanRecommendationList.aspx.vb" Inherits="PrsWorkFlow.PlanRecommendationList" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
     ...
     function funPlanProsAcp1(RowCnt)
     {
        ...
        {
            ExpMsg="Select Value For : Recommend" 
        }
        else if (document.getElementById("Accept_" + RowCnt + "_1").checked== true || document.getElementById("Accept_" + RowCnt + "_2").checked== true)
        {
     ...
     function Ajax_ApproveAcp(RowCnt)
        {
            ...
            if (document.getElementById("Accept_" + RowCnt + "_1").checked==true)    // No        
                ...
                {AcpDecision=1 }
            else if (document.getElementById("Accept_" + RowCnt + "_2").checked== true)  // Return
                {AcpDecision=3}
