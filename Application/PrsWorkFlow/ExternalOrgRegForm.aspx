<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ExternalOrgRegForm.aspx.vb" Inherits="PrsWorkFlow.ExternalOrgRegForm" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
				      ...
				      <asp:TableRow>
                        ...
                        <asp:TableCell CssClass="MainTD" Style="font-weight: bold;" ID="ExtOrgType"></asp:TableCell>
                        <asp:TableCell CssClass="MainTD">
                           <%-- <asp:DropDownList ID="ExtOrgTypeDDl" runat=server CssClass="MainTD"></asp:DropDownList>--%>
                             <asp:TextBox ID="ExtOrgTypeTxt" runat=server CssClass="ExtOrgTypeTxt" MaxLength=100 Width="200px"></asp:TextBox>
                        </asp:TableCell>
                     ...
                     <asp:TableRow>
                            <asp:TableCell CssClass="MainTD" ColumnSpan=3>
                                <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                                    HorizontalAlign="center" ID="ExtOrgTypeTab">
                                </asp:Table>
                            </asp:TableCell>
                     </asp:TableRow>
...
function taLimit() 
 ...
 function ChangeToActiveStatus(RowCnt,OrgTypeID)
 {  AjaxChangeOrgTypeStatus(RowCnt,OrgTypeID,1) }
 
 function ChangeToDeactiveStatus(RowCnt,OrgTypeID)
 {  AjaxChangeOrgTypeStatus(RowCnt,OrgTypeID,2) }
 
 function AjaxChangeOrgTypeStatus(RowCnt,OrgTypeID,Type)
   {
     var recary = new Array(); 
        ...
        xmlhttp.onreadystatechange=function()
        {
         ...
         var url="ChangeorgTypeStatus.aspx?OrgTypeID=" +  OrgTypeID + "&Type=" + Type + "&RegType=1"
