<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WrkActionPlansList.aspx.vb" Inherits="PrsWorkFlow.WrkActionPlansList" %>
	...
	<body MS_POSITIONING="GridLayout">
		...
		<script language=javascript>
            ...
            function UserStatusvalue(ReturnVal,Rowcnt)
            {
                ...
                {
                   if (GroupName !='')
                    {  alert("User Is Not Authorized To Initiate Action Items Under " +  GroupName + "/ QA_HOD Group ") }
                   else
                     { alert("User Is Not Authorized To Initiate Action Items Under  QA_HOD Group ")  }
                }
