<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MsgDisplay2.aspx.vb" Inherits="PrsWorkFlow.MsgDisplay2" %>

<%@ Register TagPrefix="uc1" TagName="MessageDisplay" Src="../CaliberCommonCtrls/MessageDisplay.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>MsgDisplay2</title>
        ...
        <table class="maintable" id="Table1" cellspacing="0" style="height: 150px; width: 520px"
            ...
            <tr class="MainTD">
                <td align="left" width="16%">
                    &nbsp;
                    <asp:Image  CssClass="HideRow" ID="img1" BorderStyle="None" runat="server"></asp:Image></td>
