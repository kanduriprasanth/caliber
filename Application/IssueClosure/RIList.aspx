...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RIList.aspx.vb" Inherits="IssueClosure.RIList" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="RecPerPageTxt" runat="server" Width="50px" CssClass="TxtCls" AutoPostBack="False"  onkeypress="return IsDigit1(event);" MaxLength=3>20</asp:TextBox>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
                                <asp:Literal ID="PgNoLtrl" runat="server"></asp:Literal>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="PgNoTxt" runat="server" AutoPostBack="False" CssClass="TxtCls" MaxLength="5"
                                    onkeypress="return IsDigit1(event);" Width="50px">1</asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
