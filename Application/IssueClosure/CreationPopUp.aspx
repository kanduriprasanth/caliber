<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreationPopUp.aspx.vb"
    Inherits="IssueClosure.CreationPopUp" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
	...
	{ 
		    ...
		    var IssTypeId=document.all("PB"+ RowCnt).innerText
		    var IssCode=document.all("IssCode"+ RowCnt).innerText
		   	opener.fnCrSetToCode(KdIdVal,KfLableVal,IssTypeId,IssCode)
	}
	function fnCrCancel(){
