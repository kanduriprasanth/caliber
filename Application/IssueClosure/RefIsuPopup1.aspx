<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RefIsuPopup1.aspx.vb" Inherits="IssueClosure.RefIsuPopup1" %>
...
//            var KfIdVal=KdIdValArr.join(",")
            opener.fnSetRefValue(IsuCode,IssueId,PrsType,IsuTypeId,<%=Request.QueryString("RowCnt")%>)
        }

	
	
	    function fnCrCancel(){
		    opener.fnSetRefValue('','','','',<%=Request.QueryString("RowCnt")%>)
		    window.self.close()
	    }
