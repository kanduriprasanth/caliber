<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreationList.aspx.vb"
    Inherits="IssueClosure.CreationList" %>
...
function fnCrSetToCode(KfIdVal,KfLableVal,IssTypeId,IssCode){
      var objId
      var obj
                                    ...
                                    <tr>
                                        <td colspan="2" class="HideRow">
                                            ...
                                            <asp:TextBox ID="KfId" runat="server" Height="0" Width="0" CssClass="HideRow" AutoPostBack="True"></asp:TextBox>
                                             <asp:TextBox ID="IssTypeId" runat="server" Height="0" Width="0" CssClass="HideRow" AutoPostBack="True"></asp:TextBox>
                                             <asp:TextBox ID="IssCodeTd" runat="server" Height="0" Width="0" CssClass="HideRow" AutoPostBack="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
