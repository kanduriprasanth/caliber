<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IssueChart.aspx.vb" Inherits="CAPAWORKS.IssueChart" %>
...
<body ms_positioning="GridLayout">
    <form id="form1" runat="server">
        <asp:Table ID="Table1" runat="server" CssClass="MainTable" HorizontalAlign="center"
            ...
            <asp:TableRow CssClass="HideRow" ID="ValueTR" > 
             <asp:TableCell CssClass="MainTD" ID="ValueTd">
            ...
            <asp:TableRow ID="ReportRow">
              <asp:TableCell runat="server" BackColor="#f7fbff" CssClass="MainTD" ID="Tablecell5">
                <TABLE id="TABLE2" style="WIDTH:100%" BORDER="0" CELLSPACING="1" CELLPADDING="1" class="MainTable"
							align="center">
							<TR class="HideRow">
							...
							<TR>
								<TD colspan="1" style="font-size:x-small ; background-color:#f7fbff; color:#96987d">&nbsp;&nbsp;&nbsp;Chart 
									Type&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<SELECT id="SELECT1" name="GraphSelect" class="TxtCls" onchange="GraphSel()">
								...
								<TD style="font-size:x-small ; background-color:#f7fbff; color:#96987d">Width <input type="button" class="ButCls"  value="+" onclick="WidthIn()"><input type="button" width="30px" class="ButCls" value="-" onclick="WidthOut()">
									Height <input type="button" class="ButCls" width="30px" value="+" onclick="HeightIn()"><input type="button"  class="ButCls" value="-" onclick="HeightOut()">
									</TD>
							</TR>
							<tr>
							  <td colspan="1" style="font-size:x-small ; background-color:#f7fbff; color:#96987d">&nbsp;&nbsp;&nbsp;Category
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:DropDownList CssClass="MainTD" ID="CategoryDDl" runat="server" ></asp:DropDownList> </td>
									
            				  <td colspan="1" style="font-size:x-small ; background-color:#f7fbff; color:#96987d">Issue Type
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:DropDownList CssClass="MainTD" ID="IsueTypeDDL" runat="server" ></asp:DropDownList>
									&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="Button1"  class="ButSelCls" value="Display Chart" onclick="GraphSel()"> </td>
               ...
               <asp:TableRow ID="ChatrCompTr" >
                    <asp:TableCell ID="GraphTD" CssClass="MainTD" BackColor="#f7fbff" Style="width: 100%">
						<div id="div1" style="POSITION: relative;BORDER-RIGHT: #f7fbff solid; BORDER-TOP: #f7fbff  solid; BORDER-LEFT: #f7fbff  solid; WIDTH: 1000px; BORDER-BOTTOM: #f7fbff  solid; HEIGHT: 200px; background-color:#f7fbff "
							align="center">
							<object id="ChartSpace1" style="background-color:#f7fbff;BORDER-RIGHT: f7fbff solid;BORDER-TOP: f7fbff  solid;BORDER-LEFT: f7fbff  solid;BORDER-BOTTOM: f7fbff  solid " classid="clsid:0002E55D-0000-0000-C000-000000000046" width="100%"
		 					    height="100%" >
  ...
  var recary = new Array(); 
            ...
            xmlhttp.onreadystatechange=function()
            {
                if(xmlhttp.readystate==4)
                {
                    ...
                    document.getElementById("ValueTd").innerHTML=DispTbl
                    var TableObjId= document.getElementById("ValueTab")
	                var r,n
	                var numCol
	                var rCount=TableObjId.rows.length//document.all(TableObjId).rows.length
	                if(rCount<2){ return(false)}
	                var  ColCount=parseInt(TableObjId.rows(0).cells.length) //document.all(TableObjId).rows(0).cells.length
                ...
                ////////////////////////////
                 ...
                 // build an assoc array of object types
                    ...
                    for(n=0;n<numColAry.length;n++){
                        ...
                        var ColHeader  = TableObjId.rows(0).cells(numCol).innerText; //document.all(TableObjId).rows(0).cells(numCol).innerText;
                        ChartObj.Charts(0).SeriesCollection(n).Caption=ColHeader;
                        var valuesAry=new Array();
                        for(r=1;r<rCount;r++)
                        {
                            yVal=TableObjId.rows(r).cells(numCol).innerText; //document.all(TableObjId).rows(r).cells(numCol).innerText
                            if(yVal==''){yVal=0}
             ...
             var url="IsuChart_Ajax.aspx?IsuCategory="+ document.getElementById("CategoryDDl").value +"&IsuTypeId="+ document.getElementById("IsueTypeDDL").value 
...
<script language="jscript">
 function ChartSpaceSelChange(){
	...
	case c.chSelectionPoint:
		 ...
		 DisplayList(ChartObj.Selection.Parent.Index)
    	 break;
	case c.chSelectionPlotArea:
		case c.chSelectionLegend:
		case c.chSelectionChart:
 ...
 function DisplayList(Type)
       {
         var recary = new Array(); 
            ...
            xmlhttp.onreadystatechange=function()
            {
             ...
             var url="IsuList_Ajax.aspx?Type="+ Type +"&IsuCategory="+ document.getElementById("CategoryDDl").value +"&IsuTypeId="+ document.getElementById("IsueTypeDDL").value 
            xmlhttp.open("POST",url,true);
            xmlhttp.send(null);
        }
