<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EFMActionPlnRpt.aspx.vb" Inherits="CAPAWORKS.EFMActionPlnRpt" %>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Table CellPadding="0" CellSpacing="0" BorderWidth="3" HorizontalAlign="center"
            CssClass="MainTable" runat="server" ID="Table1" EnableViewState="False"  Width="17in">
                 ...
                 <asp:TableCell ColumnSpan=6>
                    <asp:Table ID="SrhTbl" runat="server" HorizontalAlign="left" CellPadding="0" CssClass="SubTable"
                        ...
                        <asp:TableRow>
                           ...
                           <asp:TableCell CssClass="MainTD" ColumnSpan="1">
                                <asp:Label ID="MonitStsLbl" runat="server" Text="Monitoring Status"></asp:Label>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD" ColumnSpan="1">
                                <asp:RadioButtonList ID="MonitStsRbl" runat="server" RepeatDirection="horizontal"
                                    CssClass="MainTD">
                                    <asp:ListItem Text="All" Value="0" Selected=True ></asp:ListItem>
                                    <asp:ListItem Text="Satisfactory" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Not-Satisfactory" Value="2"></asp:ListItem>
                                </asp:RadioButtonList>
                            </asp:TableCell>
                        </asp:TableRow>
            ...
            <asp:TableRow ID="DevCtrlTabTR">
                <asp:TableCell ColumnSpan="6">
                    <asp:Table ID="ActionPlanTAb" Width="100%" runat="server" HorizontalAlign="center"
                        CellPadding="1" CssClass="SubTable" CellSpacing="1">
                    </asp:Table>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
