<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ActPlanFinalRpt.aspx.vb" Inherits="CAPAWORKS.ActPlanFinalRpt" %>
                    ...
                    <asp:Table runat="server"  Width="100%" CellPadding="0" CellSpacing="0"
                        ...
                        <asp:TableRow>
                            <asp:TableCell >
                             ...
                             <asp:TableCell ID="PrintTD" HorizontalAlign="Right" >
                            ...
                            <asp:TableCell ID="PrintCtrlTD" HorizontalAlign="Right" >
...
function _printDocumentCall()
    {
        ...
        if($.trim(document.getElementById ("Remarks").value)!="")
        {
            ...
            if (r == true) 
            {
        var PageUrl = '../CAPAWORKS/ActPlanFinalRpt_Ajax.aspx' 
        var FileName = "ActionPlanReport";
        CaliberDocumentViewerIns.CloseDocument();
        DeleteTempDocument()
        PageUrl += '?IsuTypeId=' + '<%=Request.QueryString("IsuTypeId") %>' + '&IsuLogID=' + '<%=Request.QueryString("IsuLogID") %>'+"&RptType=1&ReturnFlag=4&Type=2"+'&PreviewFlg=0'+ '&IsEmPlan=' + '<%=Request.QueryString("IsEmPlan") %>';
...
//        CaliberDocumentViewerIns.LoadWebDocument(BodyHtmFilePath,false,WordBodyHtmFilePath,false);
        ...
        AjaxUpdatePrintLog("<%=Request.QueryString("IsuLogID")%>",2,PrinterName,DriverName)
