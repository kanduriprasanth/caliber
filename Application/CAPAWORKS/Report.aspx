<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report.aspx.vb" Inherits="CAPAWORKS.Report" %>
    ...
    <form id="Form1" method="post" runat="server">
        <asp:Table CellPadding="0" CellSpacing="0" BorderWidth="3" HorizontalAlign="center"
            ...
            <asp:TableRow ID="TopChsrtTr" CssClass="HideRow">
                <asp:TableCell ID="TopChrtTd" Width="100%"></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Table ID="CrTopTable" runat="server" HorizontalAlign="center" CellPadding="0"
                        ...
                        <asp:TableRow>
                            <asp:TableCell CssClass="MainTD">
                                <asp:Table ID="FilterTab" CssClass="SubTable" 
                                    runat="server" Width="700px" CellPadding="0" CellSpacing="1" HorizontalAlign="left" 
                                    BorderWidth="0">
                                </asp:Table>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:Table ID="Reocrdtab" CssClass="SubTable" runat="server" Width="700px" BorderColor="black" CellPadding="0"
            ...
            <asp:TableRow ID="BtmChartTr" CssClass="HideRow">
                <asp:TableCell ID="BtmChrtTd" BackColor="white" Width="100%"></asp:TableCell>
            ...
            <asp:TableRow CssClass="HideRow" Height="0">
                ...
                <asp:TableCell>
                    <asp:Table ID="ChrtTab" runat="server"></asp:Table>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </form>
...
<!--
 ...
 function ExpDataToExcel() {
        ...
        try {
            var ExcelType = ExcelTypeAry[document.getElementById("GraphSelect").selectedIndex]
            if(ExcelType=="undefined")
            {
                ExcelType=1
            }
...
//            OpenExcel();	
//            var bgColor =2;
//            $("#ReportTAB thead td").each(function (index) {
//                WriteData(1,index+1,$(this).text(),20,bgColor,"@",8,"Arial","True",1)
//            });
//                                 
//            $("#ReportTAB tbody tr").each(function (Rindex) {
