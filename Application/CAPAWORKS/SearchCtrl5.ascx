<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SearchCtrl5.ascx.vb" Inherits="CAPAWORKS.SearchCtrl5" %>
...
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
			    ...
			    <option value="1">   <%=Application("ISSU007_" & "0")%></option>
				<option value="2">   <%=Application("QMS008_" & "0")%></option>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD"><%=Application("QMS008_" & "0")%> Like &nbsp;<input class="TxtCls" id="SrchTxt2" maxLength="25"  style="WIDTH: 200px" accessKey="D" type="text"
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;<%=Application("ISSU007_" & "0")%> 
	...
	<tr class="HideRow" id="SrchTr4">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">Status=&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="SrchTxt4" runat="server" AutoPostBack="false">
            <asp:ListItem Text="Under Acceptance" Value="1"></asp:ListItem>
            <asp:ListItem Text="Under Recommendation" Value="2"></asp:ListItem>
	...
	<tr class="HideRow">
		<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl1<%=UniqeIDSep%>FromDate<%=UniqeIDSep%>CalDateVal,SearchCtrl1<%=UniqeIDSep%>ToDate<%=UniqeIDSep%>CalDateVal,SearchCtrl1<%=UniqeIDSep%>SrchTxt4" name="SrchObjIds">
