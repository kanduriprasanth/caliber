<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InchUserGrpPopUp.aspx.vb" Inherits="CAPAWORKS.InchUserGrpPopUp" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
    <form id="Form1" method="post" runat="server">
        <table class="MainTable" height="100%" cellspacing="0" cellpadding="0" width="100%"
            ...
            <tr>
                <td>
                    <table width="100%" cellspacing="1" cellpadding="0" align="center" style="background-color:white">
                        <b><tr>
                            <td class="MainTd" colspan="1">
                                <asp:Literal ID="SearchOptionLtrl" runat="server">Search Option</asp:Literal>
                            </td>
                            <td class="MainTd" colspan="3"  width="70%">
	...
	{ 	
		    ...
		    var RevAppDesc=document.getElementById("RevAppDes"+ RowCnt).innerHTML
//		    
...
//           else   
//             {
                opener.fnCrIncGrpSetToCode(RevAppIdVal,RevAppCodeVal,RevAppUCodeVal,RevAppDesc)        //RevAppUCodeVal     
                document.getElementById("RBVal").value = RevAppIdVal
             //}   
		   	
	}
	function fnCrCancel(){
		opener.fnCrIncGrpSetToCode('','','','')
		window.self.close()
	}
