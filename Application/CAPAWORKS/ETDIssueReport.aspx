<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ETDIssueReport.aspx.vb"
    Inherits="CAPAWORKS.ETDIssueReport" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table ID="CrTopTable" runat="server" HorizontalAlign="center" CellPadding="0"
                        ...
                        <asp:TableRow ID="RecTabTR">
                            <asp:TableCell ColumnSpan="6">
                                <asp:Table ID="RecListTbl" runat="server" CellPadding="0" CellSpacing="1" CssClass="SubTable"
