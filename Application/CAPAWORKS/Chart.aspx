<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Chart.aspx.vb" Inherits="CAPAWORKS.Chart" %>
              ...
              <asp:TableCell runat="server" BackColor="#f7fbff" CssClass="MainTD" ID="Tablecell5">
                <TABLE id="TABLE2" style="WIDTH:100%" BORDER="0" CELLSPACING="1" CELLPADDING="1" class="MainTable"
							...
							<TR>
								...
								<TD style="font-size:x-small ; background-color:#f7fbff; color:#96987d">Width <input type="button" class="ButCls"  width="30px" value="+" onclick="WidthIn()"><input type="button"  class="ButCls" value="-" onclick="WidthOut()">
...
////////////////////////////
 ...
 // build an assoc array of object types
    ...
    for(r=1;r<rCount;r++)
    {
	    categories[r-1]=document.all(TableObjId).rows(r).cells(parseInt(txtCol)).innerText	
    } 
    var yVal
    for(n=0;n<numColAry.length;n++){
...
var ChartObj= document.getElementById("ChartSpace1")
	...
	case c.chSelectionPoint:
		 ...
		 DisplayList(ChartObj.Selection.Parent.Index,ChartObj.Selection.GetValue(c.chDimCategories))
    	 break;
	case c.chSelectionPlotArea:
		case c.chSelectionLegend:
		case c.chSelectionChart:
...
//}
 ...
 function DisplayList(WitLstType,WITType)
       {
         var recary = new Array(); 
            ...
            xmlhttp.onreadystatechange=function()
            {
             ...
             var url="Chart_Ajax.aspx?WitLstType="+ WitLstType +"&WITType="+ WITType 
