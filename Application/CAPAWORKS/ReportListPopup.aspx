<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportListPopup.aspx.vb" Inherits="CAPAWORKS.ReportListPopup" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
                        ...
                        <tr>
                            ...
                            <td class="MainTd" colspan="3">
                                <asp:RadioButtonList ID="SearchOptionRD" runat="server" RepeatDirection="Horizontal"
                                    ...
                                    <asp:ListItem Value="2">Report Desc</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                        <tr>
	...
	{ 	
            ...
            var BaseId=document.getElementById("RptId"+ RowCnt).innerHTML	
            var Reportcode=document.getElementById("Reportcode"+ RowCnt).innerHTML
            var ReportDesc=document.getElementById("ReportDesc"+ RowCnt).innerHTML
		    
             opener.SetReportID(BaseId,Reportcode,ReportDesc)     
