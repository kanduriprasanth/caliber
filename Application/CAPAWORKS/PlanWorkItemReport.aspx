<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PlanWorkItemReport.aspx.vb" Inherits="CAPAWORKS.PlanWorkItemReport" %>
								...
								<asp:TableCell CSSClass="MainTD" ColumnSpan="6">
									...
									<ASP:TABLE id="SrhTbl" runat="server" HorizontalAlign="left" CELLPADDING="0" CSSClass="SubTable"
									    ...
									    <ASP:TABLEROW>
								            ...
								            <ASP:TABLECELL CSSClass="MainTD" ColumnSpan="1">
									            <ASP:DROPDOWNLIST id="IsuCatDDL" runat="server"  Width="210px" EnableViewState="true"></ASP:DROPDOWNLIST>
								            </ASP:TABLECELL>
							            ...
							            <ASP:TABLEROW>
							                ...
							                <ASP:TABLECELL CSSClass="MainTD" ColumnSpan="1">
									            <ASP:LabeL id="InchargeTD" runat="server" Text="Incharge like"></ASP:LabeL>
								            </ASP:TABLECELL>
								            <ASP:TABLECELL CSSClass="MainTD" ColumnSpan="1">
									            <ASP:TEXTBOX id="InchargeTxt" runat="server" Text="%"></ASP:TEXTBOX>
								            </ASP:TABLECELL>
								            
							           
								            <ASP:TABLECELL CSSClass="MainTD" ColumnSpan="1">
								            <asp:TextBox ID="WidthTXt"  Text=14 runat=server CssClass="hideRow" ></asp:TextBox>
								            ...
								            <ASP:TABLECELL CSSClass="MainTD" ColumnSpan="1">
								              ...
								              <ASP:TABLECELL CSSClass="MainTD" ColumnSpan="1">
									            <ASP:LabeL id="InitBetwnLbl" runat="server" Text="Target Date"></ASP:LabeL>
								            </ASP:TABLECELL>
								            <ASP:TABLECELL CSSClass="MainTD" ColumnSpan="1">
       ...
       function WORDPRINT()
        {
          if (flag==0)
          {
           ...
           // var HeaderFilePath=HelloWorldControl1Ins.GenerateHtmlFile("Action Plan Report","HeaderData_" + (1));
            ...
            BodyData =BodyData.replace(/FONT-SIZE: 14px;/gi,"FONT-SIZE: 12px;word-wrap:break-word;")
