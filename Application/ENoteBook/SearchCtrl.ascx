<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl.ascx.vb" Inherits="ENoteBook.SearchCtrl" %>
...
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
			    ...
			    <option value="1"><%=HttpContext.Current.Application("ENB145_" & "0")%></option>
				<option value="2"><%=HttpContext.Current.Application("ENB003_" & "0")%></option>
				<option value="3"> Initiated Date</option>
		        <option value="4"><%=HttpContext.Current.Application("ENB162_" & "0")%></option>
	</SELECT> 
		</td>
	</tr>
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD"><%=Application("ENB003_" & Session("LANG"))%> Like &nbsp;<input class="TxtCls" id="SrchTxt2" style="WIDTH: 200px" accessKey="D" type="text" maxLength="250"
							value='%' name=SrchTxt2></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;<%=Application("ENB145_" & "0")%> 
            =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls" id="SrchTxt1" style="WIDTH: 200px" accessKey="D" type="text" maxLength="30"
							name="SrchTxt1" ></td>
				</tr>
			</table>
		</td>
	...
	<tr class="HideRow" id="SrchTr4">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD"><%=HttpContext.Current.Application("ENB162_" & "0")%> &nbsp;
             
				<select name="SrchTxt4" id="SrchTxt4" class="RBList" style="width:200px;" onchange ="SetSecTxtVal()">
					<%--<option value="1"><%=HttpContext.Current.Application("ENB163_" & "0")%></option>
                 	<option value="2"><%=HttpContext.Current.Application("ENB164_" & "0")%></option>
					<option value="0"><%=HttpContext.Current.Application("ENB241_" & "0")%></option>--%>
					<option value="1">GenericTpltCaption</option>
                 	<option value="2">MasterDocumentCaption</option>
					<option value="3">ExecDocumentCaption</option>
					<option value="4">eFormPrepCaption</option>
					<option value="5">eFormExecCaption</option>
                </select>
                <asp:TextBox ID="SrchTxt4Txt" runat=server CssClass ="HideRow"></asp:TextBox>
                </td> 
				</tr>
			</table>
           </td>
	...
	<tr class="HideRow">
		<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl1<%=UniqeIDSep%>FromDate<%=UniqeIDSep%>CalDateVal,SearchCtrl1<%=UniqeIDSep%>ToDate<%=UniqeIDSep%>CalDateVal,SrchTxt4" name="SrchObjIds">
...
<!--
 var SearchTxtVal
 var SearchTypeVal=0
  function SetSecTxtVal()
 {
    document.getElementById ("SearchCtrl1_SrchTxt4Txt").value = document.getElementById ("SrchTxt4").value
 }
...
function SetSearchTxt(){
	...
	if(SrchObjIdVal!=''){
	    ...
	    for(i=0;i<SrchObjIdAry.length;i++){
		    if(document.forms(0).all(SrchObjIdAry[i]))
 ...
 ///////////////
  ...
  DisplayFilterTab()
 /////////////////
    document.getElementById ("SrchTxt4").value = document.getElementById ("SearchCtrl1_SrchTxt4Txt").value
