<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PrfxPopUp.aspx.vb" Inherits="UcodeGen.PrfxPopUp" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>Prefix List</title>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
                            ...
                            <tr>
                                ...
                                <td class="MainTd" colspan="3">
                                    <asp:RadioButtonList ID="SearchOptionRD" runat="server" RepeatDirection="Horizontal"
                                        ...
                                        <asp:ListItem Value="1" Selected="True">UID Type</asp:ListItem>
                                        <asp:ListItem Value="2">UID Prefix</asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                            </tr>
                            <tr>
	...
	{ 
	    ...
	    opener.fnPrfxSetToCode(KfLableVal)
	}
	function fnCrCancel(){
