<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UcodeTypReg.aspx.vb" Inherits="UcodeGen.UcodeTypReg" %>
            ...
            <asp:TableCell>
                ...
                <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                    ...
                    <asp:TableRow ID="RegistrationTr">
                        ...
                        <asp:TableCell CssClass="MainTD">
                            <asp:TextBox ID="DescTxt" runat="server" CssClass="TxtCls" MaxLength="50" Width="100px"
                                AccessKey="D" TabIndex="1"></asp:TextBox>
                        </asp:TableCell>
                        <asp:TableCell CssClass="MainTD" Style="font-weight: bold;" ID="PrfxTd"></asp:TableCell>
                        <asp:TableCell CssClass="MainTD">
                            <asp:TextBox ID="PrfxTxt" runat="server" CssClass="TxtCls" MaxLength="3" Width="100px"
                                AccessKey="D" TabIndex="1"></asp:TextBox>
                        </asp:TableCell>
                        <asp:TableCell CssClass="MainTD">
         ...
         function ShowConfermationMessage() {
             ...
             if (ConfermationMessage != "") {
                 if (ConfermationMessage.indexOf("Already Registered") > -1) {
                     ...
                     document.getElementById("PrfxTxt").value = ""
                 }
                 else {
...
function FnOpenAuditPage(i,BaseId,FldDesc)  
        {
        // ShowMask()
            var pageURL = "UIAudit.aspx?Type=1&BaseId=" + BaseId + "&FldDesc=" + FldDesc
