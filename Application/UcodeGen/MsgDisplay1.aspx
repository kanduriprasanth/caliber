<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MsgDisplay1.aspx.vb" Inherits="UcodeGen.MsgDisplay1" %>
...
<TABLE class="maintable" id="Table1" cellSpacing="0" style="HEIGHT:150px; width:520px"
	align="center">
	<tr class="MainHead">
		<td align="left" colSpan="4">&nbsp;<asp:label id="Label1" runat="server"  Font-Names="Verdana" Font-Size="15px" ForeColor="black">&nbsp;Caliber LIMS</asp:label>&nbsp;<asp:label id="Label2" runat="server" Font-Bold="True" Font-Names="Verdana" Font-Size="12px"
