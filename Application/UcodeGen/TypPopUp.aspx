<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TypPopUp.aspx.vb" Inherits="UcodeGen.TypPopUp" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
                            ...
                            <tr>
                                ...
                                <td class="MainTd" colspan="3">
                                    <asp:RadioButtonList ID="SearchOptionRD" runat="server" RepeatDirection="Horizontal"
                                        ...
                                        <asp:ListItem Value="1" Selected="True">Item Type</asp:ListItem>
                                        <asp:ListItem Value="2">Item Prefix</asp:ListItem>
                                    </asp:RadioButtonList>
                                </td>
                            </tr>
                            <tr>
	...
	{ 
	    ...
	    opener.fnTypSetToCode(KfLableVal)
	}
	function fnCrCancel(){
