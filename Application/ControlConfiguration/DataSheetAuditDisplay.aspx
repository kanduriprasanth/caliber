<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DataSheetAuditDisplay.aspx.vb" Inherits="ControlConfiguration.DataSheetAuditDisplay" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>Data Sheet Audit Display</title>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <asp:Table CellPadding="0" CellSpacing="0" BorderWidth="0" HorizontalAlign="center"
            CssClass="MainTable" Width="100%" runat="server" ID="Table1" EnableViewState="False">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTd" Width="80%" valign="top">
                                <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="0"
                                    ...
                                    <asp:TableRow>
                                        <asp:TableCell>
                                            <asp:Table ID="RowDispTab" runat="server" CssClass='SubTable' Width="100%" CellPadding="0"
                                                CellSpacing="1" HorizontalAlign="Center">
                                            </asp:Table>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow>
                                        <asp:TableCell>
                                            <asp:Table ID="TitleTbl" runat="server" CellPadding="0" CellSpacing="1" CssClass='SubTable'
                                    ...
                                    <asp:TableRow>
                                        <asp:TableCell>
                                            <asp:Table ID="SubTabDisp" runat="server" CellPadding="0" CellSpacing="1" CssClass='SubTable'
                                                HorizontalAlign="Center" Width="100%">
                                            </asp:Table>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow>
                                        <asp:TableCell>
                                            <asp:Table ID="RecDisTab" runat="server" CellPadding="0" CellSpacing="1" CssClass='SubTable'
                                                HorizontalAlign="Center" Width="100%">
                                            </asp:Table>
                                        </asp:TableCell>
                                    </asp:TableRow>
