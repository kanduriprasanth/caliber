<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ControlConfigStatusChgList.aspx.vb" Inherits="ControlConfiguration.ControlConfigStatusChgList" %>
...
<head>
    ...
    <script language="javascript">
        function fnback() {
            ...
            window.navigate("../ControlConfiguration/ControlConfigList.aspx?ListType=SC");
        }  
    </script>
    <script language="javascript">
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <script language="javascript">
            ...
            function fnUpdateSts(RowCnt, FldID, status) {
                // ShowMask()
                var ctrlid = "<%=DataTyp%>"
                var pageURL = "CommonStatusChange.aspx?FldID=" + FldID + "&status=" + status + "&Type=2" + "&ctrlid=" + ctrlid + "&title=" + '<%=MainTitleLtrl.text %>'
                var PWidth = 650
                var PHeight = 300
                var ScreenLeft = parseInt(window.screen.width - PWidth) / 2;
                var ScreenTop = parseInt(window.screen.height - PHeight) / 2;
