<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FldItemStatusChgList.aspx.vb" Inherits="ControlConfiguration.FldItemStatusChgList" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function FnOpenAuditPage(i) {
            debugger
            //ShowMask()
            var FldIdVal
            var FldName = document.getElementById("ItemFldVal" + i).innerHTML
            var FldId = '<%=ViewState("DataType")%>'
            if (FldId != '') {
                FldIdVal = FldId
            }
            var pageURL = "FldItemAudDisplay.aspx?FldId=" + FldIdVal + "&FldName=" + FldName
        ...
        function FnOpenUpdAuditPage(i) {
            debugger
            //ShowMask()

            var FldName = document.getElementById("ItemFldVal" + i).innerHTML
            var FldId = '<%=Request.QueryString("Fldid")%>'
            var pageURL = "WrkAllType2UpdateAT.aspx?FldId=" + FldId + "&FldName=" + FldName
...
<body>
                    ...
                    <asp:TableRow >
                        ...
                        <asp:TableRow>
                            <asp:TableCell CssClass="MainTD" ColumnSpan=2>
                                <asp:Table ID="TaskRegTab" CssClass="SubTable" runat="server" Width="100%" CellPadding="0" CellSpacing="0" HorizontalAlign="center"
  ...
  <script language="javascript">
      ...
      function fnUpdateSts(RowCnt, FldID, Datatype, status, WrkDepFlag) {
          ...
          var pageURL = "CommonStatusChange.aspx?FldID=" + FldID + "&CurrentItemCnt=" + RowCnt + "&FldStatus=" + status + "&Datatype=" + Datatype + "&WRkDepFlag=" + WrkDepFlag + "&SeqId=" + SeqId + "&WrkDepdncy=" + WrkDepdncy + "&ItemName=" + encodeURIComponent(ItemName) + "&Type=3" + "&title=" + "<%=MainTitleLtrl.text %>"
