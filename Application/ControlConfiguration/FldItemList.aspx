<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FldItemList.aspx.vb" Inherits="ControlConfiguration.FldItemList" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function FnOpenAuditPage(i) {
            ...
            var pageURL = "FldItemAudDisplay.aspx?FldName=" + encodeURIComponent(FldName) + "&CtrlID=" + "<%=Fldid%>"
