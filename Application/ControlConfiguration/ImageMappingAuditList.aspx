<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ImageMappingAuditList.aspx.vb" Inherits="ControlConfiguration.ImageMappingAuditList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html lang="en">
<head id="Head1" runat="server">
    <title>Image Mapping Audit List</title>
        ...
        <asp:Table ID="tt" CellPadding="0" CellSpacing="1" BorderWidth="3" HorizontalAlign="center"
            ...
            <asp:TableRow Height="20">
                <asp:TableCell CssClass="MainHead">
                    <asp:Literal ID="MainTitleLtrl" runat="server">Flow Chart Configuration</asp:Literal>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
