<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MsgDisplay1.aspx.vb" Inherits="ControlConfiguration.MsgDisplay1" %>
                ...
                <td class="maintd1" colspan="4">
                    <div align="left">
                       ...
                       <asp:Button  runat=server ID="Back1" CssClass="butCls" Text="     Home   " />
                        <asp:Button  runat=server ID="Button1" CssClass="butCls" Text="     Next   " />s
                        </div>
                </td>
            </tr>
        </table>
