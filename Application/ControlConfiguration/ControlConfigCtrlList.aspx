<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ControlConfigCtrlList.aspx.vb" Inherits="ControlConfiguration.ControlConfigCtrlList" %>
...
<head>
    ...
    <script language="javascript">
        function fnback() {
            window.navigate("../ControlConfiguration/ControlConfigList.aspx?ListType=AT");
        }  
    </script>
    ...
    <script language="javascript">
        ...
        function FnOpenAuditPage(i, DataTyp, CtrlId, CrlName) {
            // ShowMask()
            var pageURL = "ControlConfigAudDisplay.aspx?DataTyp=" + DataTyp + "&CtrlId=" + CtrlId + "&CtrlName=" + CrlName
