<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TaskTypRegAuditDisplay.aspx.vb" Inherits="ControlConfiguration.TaskTypRegAuditDisplay" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Table ID="tt" CellPadding="0" CellSpacing="0" BorderWidth="0" HorizontalAlign="center"
            ...
            <asp:TableRow Height="20">
                <asp:TableCell CssClass="MainHead">
                     	<INPUT class="ButCls" onmouseover="this.className='ButOCls'" style="WIDTH: 50px" onmouseout="this.className='ButCls'" type="button" value="Close" onclick = "fnclose()" > 
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </form>
