<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Trn.aspx.vb" Inherits="ControlConfiguration.Trn" %>
            ...
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow >
                          <asp:TableCell CssClass="MainTD" ID="ControlTypeTD" ></asp:TableCell>
                          <asp:TableCell CssClass="MainTD">
                            <asp:DropDownList ID="ControlTypDDl" runat=server ></asp:DropDownList>
                          </asp:TableCell>
                        </asp:TableRow>
