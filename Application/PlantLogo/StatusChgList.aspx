...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="StatusChgList.aspx.vb" Inherits="PlantLogo.StatusChgList" %>
						...
						<asp:Literal id="SubTitleLtrl" runat="server"></asp:Literal>
						  ...
						  <asp:TableRow >
							...
							<asp:Tablerow>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox ID="RecPerPageTxt" Runat="server" MaxLength="3" Width="50px" CssClass="TxtCls" AutoPostBack="False">10</asp:TextBox>
								</asp:TableCell>
