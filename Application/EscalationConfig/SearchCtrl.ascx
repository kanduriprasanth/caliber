<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl.ascx.vb" Inherits="EscalationConfig.SearchCtrl"%>
	...
	<tr>
		<td class="SubHeadTD" colSpan="2" align="left">&nbsp;&nbsp;Search 
			...
			<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD" >
				...
				<option value="2">Escalation Description</option>
				<option value="1">Escalation Unique Code</option>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				...
				<tr>
					<td class="MainTD">
						Escalation Description Like&nbsp;&nbsp;&nbsp;<input class="TxtCls" id="SrchTxt2" style="WIDTH: 200px" accessKey="D" type="text" maxLength="300"
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp; Escalation Unique Code =&nbsp;&nbsp;&nbsp;&nbsp;<input class="TxtCls" id="SrchTxt1" style="WIDTH: 200px" accessKey="D" type="text" maxLength="300"
							 name="SrchTxt1"></td>
				</tr>
			</table>
		</td>
