...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AppList.aspx.vb" Inherits="EscalationConfig.AppList" %>
					...
					<asp:TableCell>
						...
						<asp:Table runat="server" CSSClass="SubTable" width="100%" CELLPADDING="0" cellspacing="1"
							...
							<asp:Tablerow>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox ID="RecPerPageTxt" Runat="server" Width="30px" MaxLength="4" CssClass="TxtCls" AutoPostBack="False">10</asp:TextBox>
								</asp:TableCell>
								<asp:TableCell CssClass="MainTD">
									<asp:Literal id="PgNoLtrl" Runat="server"></asp:Literal>
								</asp:TableCell>
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox ID="PgNoTxt" Runat="server" Width="30px" MaxLength="4" CssClass="TxtCls" AutoPostBack="False">1</asp:TextBox>
								</asp:TableCell>
							</asp:Tablerow>
							<asp:TableRow>
