<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EscalationNodePopUp.aspx.vb" Inherits="EscalationConfig.EscalationNodePopUp" %>


<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Escalation Node List</title>
	...
	<body MS_POSITIONING="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
		<form id="Form1" method="post" runat="server">
			<TABLE class="MainTable" height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center"
				...
				<!-- MAIN HEADER -->
				<TR>
					<TD class="MainHead">Escalation Node List</TD>
				</TR>
				<TR>
					<TD>
...
function fnCrCancel(){
        var iValue=<%=iValue%>
        var jValue=<%=jValue%>
	 	opener.fnGetEscalationVal('','','',iValue,jValue)
		window.self.close()
	}
	...
	{   var iValue=<%=iValue%>
		...
		opener.fnGetEscalationVal(KdIdVal,KdCodeVal,KfLableVal,iValue,jValue)
	}
