<%@ Page Language="vb" AutoEventWireup="false" Codebehind="App.aspx.vb" Inherits="EFormIssuance.App" %>
...
<HTML>
	<HEAD>
		...
		<link rel="stylesheet" href="../ENBHeaderFooter/editor/css/fck_editorarea.css">
...
//-->
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:table id="Table3" runat="server" CELLPADDING="0" CELLSPACING="0" BorderWidth="0" HorizontalAlign="center"
						...
						<asp:Table runat="server" CSSClass="SubTable" width="100%" CELLPADDING="0" cellspacing="0"
							...
							<asp:TableRow>
								...
								<asp:TableCell CssClass="MainFoot" HorizontalAlign="Right">
									<asp:HyperLink ID="Hlink" Runat="server" CssClass="HideRow" onMouseOver="this.className='ButexOCls'"
										onMouseOut="this.className='ButexCls'" AccessKey="V"></asp:HyperLink>
