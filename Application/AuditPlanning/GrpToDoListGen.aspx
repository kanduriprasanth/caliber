<%@ Page Language="vb" AutoEventWireup="false" Codebehind="GrpToDoListGen.aspx.vb" Inherits="AuditPlanning.GrpToDoListGen"%>
<%@ Register TagPrefix="uc1" TagName="SearchCtrl" Src="SearchCtrl.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>GrpToDoListGen</title>
			...
			<asp:table CELLPADDING="0" CELLSPACING="0" BorderWidth="3" HorizontalAlign="center" cssclass="MainTable"
				...
				<asp:TableRow Height="20">
					<asp:TableCell CssClass="MainHead">
						<asp:Literal ID="MainTitleLtrl" Runat="server">Status Record</asp:Literal>
					</asp:TableCell>
				</asp:TableRow>
				<asp:TableRow>
					<asp:TableCell>
						...
						<asp:Table runat="server" CSSClass="SubTable" width="100%" CELLPADDING="0" cellspacing="1"
							...
							<asp:TableRow>
								<asp:TableCell CSSClass="SubHead" ColumnSpan="7">
									<asp:Literal id="SubTitleLtrl" runat="server">Group Task List</asp:Literal>
								</asp:TableCell>
							</asp:TableRow>
							<asp:TableRow>
