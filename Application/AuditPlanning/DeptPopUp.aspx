<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DeptPopUp.aspx.vb" Inherits="AuditPlanning.DeptPopUp" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
    ...
    for(var k=0;k<<%=RecordCnt%>;k++)
    {
        ...
        {
            KfLableValArr.push(document.all("KdDes"+ k).innerText + '(' + document.all("KfLable"+ k).innerHTML + ')')
        ...
        opener.fnGetFormDeptVal(KdIdVal,KdCodeVal,KfLableVal,KdDesVal)
    }
