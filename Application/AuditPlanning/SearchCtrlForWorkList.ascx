<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrlForWorkList.ascx.vb" Inherits="AuditPlanning.SearchCtrlForWorkList" %>
...
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
			    ...
			    <option value="1"> Schedule Code</option>			    							
			</SELECT>
		</td>
	</tr>
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Task Like &nbsp;<input class="TxtCls" id="SrchTxt2" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
	...
	<tr class="HideRow" id="SrchTr4">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;Classification 
            =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls" id="SrchTxt4" style="WIDTH: 200px" accessKey="D" type="text" maxLength="250"
							name="SrchTxt4" ></td>
				</tr>
			</table>
		</td>
	...
	<tr class="HideRow">
		<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl1:FromDate:CalDateVal,SearchCtrl1:ToDate:CalDateVal,SrchTxt4"
				name="SrchObjIds">
...
function ResetSearchState(){
   var datval,curDateVal,dateval1,curDateVal1
