...
(function($) {
	...
	function createElement(text) {
		...
		var content = "<div style='width:" +width+ "px; height:" +Height+ "px; background-color:#FFFF99; border-width:1px; border-style:groove; text-align:center; line-height:" +Height+ "px; font-weight:bolder; color:#999999;'>"+text+"</div>";
