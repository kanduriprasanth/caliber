<%@ Page Language="C#" AutoEventWireup="true" Codebehind="MsgDisplay.aspx.cs" Inherits="DMSManagement.MsgDisplay" %>
			...
			<tr class="MainHead">
				<td align="left" colspan="4">
					&nbsp;<asp:Label ID="Label1" runat="server" Font-Names="Verdana" Font-Size="15px"
						ForeColor="black">&nbsp;Caliber DMS</asp:Label>&nbsp;<asp:Label ID="Label2" runat="server"
