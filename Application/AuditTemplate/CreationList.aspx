<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreationList.aspx.vb" Inherits="AuditTemplate.CreationList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Audit Design CreationList</title>
...
function fnCrSetToCode(KfIdVal,KfLableVal,KfLableVal1){
      var objId
      var obj
							...
							<ASP:TABLEROW>
								<ASP:TABLECELL CssClass="MainTD" ColumnSpan="5">
									<TABLE Align="center" CELLPADDING="0" class="SubTable" cellspacing="1" width="100%">
										<tr>
											<td Style="WIDTH:200px" class="MainTd">
												Header Code &nbsp; <INPUT type="button" onclick="fnOpenCrPopUp()" class='RsnPUP' style="HEIGHT:20px" title="Click Here">
											</td>
											<td class="MainTd">
										...
										<TR>
											...
											<asp:RequiredFieldValidator id="ReqFieldValidator1" runat="server" ControlToValidate="KfId" Height="0" Width="0">&nbsp;</asp:RequiredFieldValidator>
												...
												<asp:TextBox id="Kf1Id" runat="server" Height="0" Width="0" CssClass="HideRow" AutoPostBack="True"></asp:TextBox>
											</TD>
										</TR>
									</TABLE>
