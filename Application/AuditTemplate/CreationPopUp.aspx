<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreationPopUp.aspx.vb" Inherits="AuditTemplate.CreationPopUp" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
		<form id="Form1" method="post" runat="server">
			<TABLE class="MainTable" height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center"
				...
				<!-- MAIN HEADER -->
				<TR>
					<TD class="MainHead">Audit Header Template List
					</TD>
				</TR>
				<TR>
					<TD>
								...
								<Tr>
									...
									<td class="MainTd" colspan="3">
										<asp:RadioButtonList ID="SearchOptionRD" Runat="server" RepeatDirection="Horizontal" CellPadding="0"
											...
											<asp:ListItem Value="1" Selected="True">Header Code</asp:ListItem>
											<asp:ListItem Value="2">Audit Title </asp:ListItem>
										</asp:RadioButtonList>
									</td>
								</Tr>
								<tr>
	...
	{ 
		    ...
		    var KfLableVal1=document.all("KfLable_1"+RowCnt).innerHTML
		   document.getElementById("RBVal").value = KfLableVal
		   	opener.fnCrSetToCode(KdIdVal,KfLableVal,KfLableVal1)
	}
	function fnCrCancel(){
