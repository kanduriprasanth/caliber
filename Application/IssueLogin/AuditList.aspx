...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AuditList.aspx.vb" Inherits="IssueLogin.AuditList" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table ID="CrTopTable" runat="server" HorizontalAlign="center" CellPadding="0"
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="PgNoTxt" runat="server" AutoPostBack="False"  MaxLength=5 CssClass="TxtCls" onkeypress="return IsDigit1(event);"
