...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IssRevAppList.aspx.vb" Inherits="IssueLogin.IssRevAppList" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		...
		var IsuCategoy=''
		    function RasiSelAlert(FunctionID,IssueLogId,RowCnt,Category,DeptName)
		    {         
		     IsuCategoy=Category
		      //QAMS_WRK_ALL_SpecialValidations(FunctionID,IssueLogId,RowCnt)
		      //AjaxCheckUserExisInGroup(IssueLogId,RowCnt,DeptName)
            ...
            {
                if (ReturnVal=="0")
                   alert("User Is Not Authorized  To Approve " + IsuCategoy  + " Under This Department ")
                 else
