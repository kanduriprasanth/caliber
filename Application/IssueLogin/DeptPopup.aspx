<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DeptPopup.aspx.vb" Inherits="IssueLogin.DeptPopup" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
                        ...
                        <tr>
                            ...
                            <td class="MainTd" colspan="3">
                                <asp:RadioButtonList ID="SearchOptionRD" runat="server" RepeatDirection="Horizontal"
                                    ...
                                    <asp:ListItem Value="1" Selected="True">Department Code</asp:ListItem>
                                    <asp:ListItem Value="2">Department Name</asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                        <tr>
	...
	{ 	
            ...
            var DeptId=document.getElementById("DeptId"+ RowCnt).innerHTML	
            var DeptCode=document.getElementById("DeptCode"+ RowCnt).innerHTML
            var DeptAulID=document.getElementById("DeptAulID"+ RowCnt).innerHTML
		    var Deptname=document.getElementById("Deptname"+ RowCnt).innerHTML
             opener.fnSetDeptCode("<%=Request.QueryString("id") %>",DeptId,DeptAulID,DeptCode,Deptname)     
                document.getElementById("RBVal").value = DeptId
             //}   
		   	
	}
	function fnCrCancel(){
		 opener.fnSetDeptCode("<%=Request.QueryString("id") %>",'','','','')     
		window.self.close()
	}
