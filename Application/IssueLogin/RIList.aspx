...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RIList.aspx.vb" Inherits="IssueLogin.RIList" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="RecPerPageTxt" runat="server" Width="50px" CssClass="TxtCls" AutoPostBack="False" MaxLength=3 onkeypress="return IsDigit1(event);">20</asp:TextBox>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
