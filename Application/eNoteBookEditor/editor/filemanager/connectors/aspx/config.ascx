...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        string  Str  = Request.ServerVariables.Get("APPL_MD_PATH");
        Int32 StrLen    = Str.LastIndexOf("/");
        UserFilesPath = "/" + Str.Substring(StrLen + 1, Str.Length - (1 + StrLen)) + "/userfiles/";

       // UserFilesPath = Request.ServerVariables.Get["APPL_MD_PATH"].;  //"/TAG_WORKS/userfiles/";
