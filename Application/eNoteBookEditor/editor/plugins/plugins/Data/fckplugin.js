...
FCKCommands.RegisterCommand( 'Data', new FCKDialogCommand( 'Data', FCKLang.CreateData, FCKPlugins.Items['Data'].Path + 'fck_Data.html', 400, 350 ) ) ;


// Create the "Placeholder" toolbar button.
var oPlaceholderItem = new FCKToolbarButton( 'Data', FCKLang.PlaceholderBtn ) ;
oPlaceholderItem.IconPath = FCKPlugins.Items['Data'].Path + 'inserttext.png' ;

FCKToolbarItems.RegisterItem( 'Data', oPlaceholderItem ) ;

// The object used for all Data operations.
var FCKData = new Object() ;

// Add a new Data at the actual selection.
...
// We must process the SPAN tags to replace then with the real resulting value of the Data.
