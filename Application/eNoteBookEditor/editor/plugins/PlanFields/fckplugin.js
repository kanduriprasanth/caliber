...
FCKCommands.RegisterCommand( 'PlanFields', new FCKDialogCommand( 'PlanFields', FCKLang.PlanFields, FCKPlugins.Items['PlanFields'].Path + 'PlanFields.html', 400, 450 ) ) ;

// Create the "Placeholder" toolbar button.
var oPlaceholderItem = new FCKToolbarButton( 'PlanFields', FCKLang.PlaceholderBtn ) ;
oPlaceholderItem.IconPath = FCKPlugins.Items['PlanFields'].Path + 'PlanFields.png' ;
oPlaceholderItem.Tooltip =FCKLang.PlanFields
FCKToolbarItems.RegisterItem( 'PlanFields', oPlaceholderItem ) ;
...
FCKData.OnDoubleClick = function( span )
{
	if ( span.tagName == 'SPAN' && span._fckplaceholder )
		FCKCommands.GetCommand( 'PlanFields' ).Execute() ;
}
