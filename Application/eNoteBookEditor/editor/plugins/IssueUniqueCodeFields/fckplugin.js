...
FCKCommands.RegisterCommand( 'IssueUniqueCodeFields', new FCKDialogCommand( 'IssueUniqueCodeFields', FCKLang.IssueUniqueCodeFields, FCKPlugins.Items['IssueUniqueCodeFields'].Path + 'IssueUniqueCodeFields.html', 400, 350 ) ) ;


// Create the "Placeholder" toolbar button.
var oPlaceholderItem = new FCKToolbarButton( 'IssueUniqueCodeFields', FCKLang.PlaceholderBtn ) ;
oPlaceholderItem.IconPath = FCKPlugins.Items['IssueUniqueCodeFields'].Path + 'IssueUniqueCodeFields.png' ;
oPlaceholderItem.Tooltip =FCKLang.IssueUniqueCodeFields
FCKToolbarItems.RegisterItem( 'IssueUniqueCodeFields', oPlaceholderItem ) ;
...
FCKData.OnDoubleClick = function( span )
{
	if ( span.tagName == 'SPAN' && span._fckplaceholder )
		FCKCommands.GetCommand( 'IssueUniqueCodeFields' ).Execute() ;
}
