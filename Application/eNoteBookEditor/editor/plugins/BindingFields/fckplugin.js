...
FCKCommands.RegisterCommand( 'BindingFields', new FCKDialogCommand( 'BindingFields', FCKLang.BindingFields, FCKPlugins.Items['BindingFields'].Path + 'BindingFields.html', 400, 350 ) ) ;


// Create the "Placeholder" toolbar button.
var oPlaceholderItem = new FCKToolbarButton( 'BindingFields', FCKLang.PlaceholderBtn ) ;
oPlaceholderItem.IconPath = FCKPlugins.Items['BindingFields'].Path + 'bindingfields.png' ;
oPlaceholderItem.Tooltip =FCKLang.BindingFields
FCKToolbarItems.RegisterItem( 'BindingFields', oPlaceholderItem ) ;
...
FCKData.OnDoubleClick = function( span )
{
	if ( span.tagName == 'SPAN' && span._fckplaceholder )
		FCKCommands.GetCommand( 'BindingFields' ).Execute() ;
}
