...
FCKCommands.RegisterCommand( 'InputFields', new FCKDialogCommand( 'InputFields', FCKLang.InputFields, FCKPlugins.Items['InputFields'].Path + 'InputFields.html', 400, 400 ) ) ;


// Create the "Placeholder" toolbar button.
var oPlaceholderItem = new FCKToolbarButton( 'InputFields', FCKLang.PlaceholderBtn ) ;
oPlaceholderItem.IconPath = FCKPlugins.Items['InputFields'].Path + 'InputFields.png' ;
oPlaceholderItem.Tooltip =FCKLang.InputFields
FCKToolbarItems.RegisterItem( 'InputFields', oPlaceholderItem ) ;
...
FCKData.OnDoubleClick = function( span )
{
	if ( span.tagName == 'SPAN' && span._fckplaceholder )
		FCKCommands.GetCommand( 'InputFields' ).Execute() ;
}
