...
FCKCommands.RegisterCommand( 'WorkIssuenceFields', new FCKDialogCommand( 'WorkIssuenceFields', FCKLang.WorkIssuenceFields, FCKPlugins.Items['WorkIssuenceFields'].Path + 'WorkIssuenceFields.html', 400, 350 ) ) ;


// Create the "Placeholder" toolbar button.
var oPlaceholderItem = new FCKToolbarButton( 'WorkIssuenceFields', FCKLang.PlaceholderBtn ) ;
oPlaceholderItem.IconPath = FCKPlugins.Items['WorkIssuenceFields'].Path + 'WorkIssuenceFields.png' ;
oPlaceholderItem.Tooltip =FCKLang.WorkIssuenceFields
FCKToolbarItems.RegisterItem( 'WorkIssuenceFields', oPlaceholderItem ) ;

// The object used for all WorkIssuenceFields operations.
var FCKData = new Object() ;

// Add a new WorkIssuenceFields at the actual selection.
...
// Open the WorkIssuenceFields dialog on double click.
FCKData.OnDoubleClick = function( span )
{
	if ( span.tagName == 'SPAN' && span._fckplaceholder )
		FCKCommands.GetCommand( 'WorkIssuenceFields' ).Execute() ;
}
...
// We must process the SPAN tags to replace then with the real resulting value of the WorkIssuenceFields.
