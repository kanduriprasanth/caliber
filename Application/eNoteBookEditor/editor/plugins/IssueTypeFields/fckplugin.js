...
FCKCommands.RegisterCommand( 'IssueTypeFields', new FCKDialogCommand( 'IssueTypeFields', FCKLang.IssueTypeFields, FCKPlugins.Items['IssueTypeFields'].Path + 'IssueTypeFields.html', 400, 350 ) ) ;
...
oPlaceholderItem.Tooltip =FCKLang.IssueTypeFields
