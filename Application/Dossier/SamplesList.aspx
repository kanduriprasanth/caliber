<%@ Register TagPrefix="uc1" TagName="SearchCtrl1" Src="SearchCtrl1.ascx" %>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SamplesList.aspx.vb" Inherits="Dossier.SamplesList" %>
			...
			<asp:table CELLPADDING="0" CELLSPACING="0" BorderWidth="0" HorizontalAlign="center" cssclass="MainTable"
				...
				<ASP:TABLEROW Height="20">
					<ASP:TABLECELL CssClass="MainHead">
						<ASP:LITERAL id="MainTitleLtrl" Runat="server">Dossier Request</ASP:LITERAL>
					</ASP:TABLECELL>
				</ASP:TABLEROW>
				<ASP:TABLEROW>
						...
						<ASP:TABLE id="CrTopTable" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
							...
							<ASP:TABLEROW>
								<ASP:TABLECELL CSSClass="SubHead" ColumnSpan="6">
									<ASP:LITERAL id="SubTitleLtrl" runat="server">Samples List</ASP:LITERAL>
								</ASP:TABLECELL>
							</ASP:TABLEROW>
							<asp:TableRow>
								<asp:TableCell CSSClass="MainTD" ColumnSpan="6">
									<uc1:SearchCtrl1 id="SearchCtrl1" runat="server"></uc1:SearchCtrl1>
								</asp:TableCell>
							</asp:TableRow>
