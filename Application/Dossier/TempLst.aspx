<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TempLst.aspx.vb" Inherits="Dossier.TempLst" %>
                ...
                <asp:TableCell ColumnSpan="2" ID="ValidatorsTd">
                    <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowSummary="False"
                        ShowMessageBox="True"></asp:ValidationSummary>
                          <asp:CustomValidator ID="CustVal" runat="server" ClientValidationFunction="validateListSel"></asp:CustomValidator>
    ...
    function fncheck()
    {
      ...
      function fnOpenCrPopUp(){
        ...
        function validateListSel(src,args)
        {
           ...
           if (document.getElementById("IsuFormIdTxt").value=="" && document.getElementById("EFormIdTxt").value=="" )
           {
            SelFldCnt=1
           } 
