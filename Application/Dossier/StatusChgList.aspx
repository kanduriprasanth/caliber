...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StatusChgList.aspx.vb"
    Inherits="Dossier.StatusChgList" %>
...
//        var ActLb, InActLb
        $(document).ready(function () {
            $("#ActLb").attr("href", "javascript:__doPostBack('ActLb','')");
            $("#InActLb").attr("href", "javascript:__doPostBack('InActLb','')");
//            ActLb = document.getElementById("ActLb");
//            InActLb = document.getElementById("InActLb");
        });
    </script>
</head>
