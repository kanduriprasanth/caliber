<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ForcedClosureRpt.aspx.vb" Inherits="ModificationRequest.ForcedClosureRpt" %>
...
<html>
<head>
    <title>Forced Closure Report</title>
    ...
    function fnEventsDetails(FclsID)
    {
        var pageURL = "../ModificationRequest/ForcedClsEventDetails.aspx?FclsID=" + FclsID 
                            ...
                            <asp:TableCell ColumnSpan="6">
                                <asp:Table ID="SrhTbl" runat="server" HorizontalAlign="left" CellPadding="0" CssClass="SubTable"
                                    ...
                                    <asp:TableRow>
                                        ...
                                        <asp:TableCell CssClass="MainTD" ColumnSpan="1">
                                            <asp:TextBox ID="IsseucodeTxt" runat="server" MaxLength="50" Text="%"></asp:TextBox>
                                        </asp:TableCell>
                                        
                                         <asp:TableCell CssClass="MainTD" ColumnSpan="1">
                                            <asp:Label ID="IsuFormLbl" runat="server" Text="Issue Form like"></asp:Label>
                                        </asp:TableCell>
                                        
                                        <asp:TableCell CssClass="MainTD" ColumnSpan="1">
                                            <asp:TextBox ID="IsuFormTXt" runat="server" MaxLength="50" Text="%"></asp:TextBox>
                                        </asp:TableCell>
