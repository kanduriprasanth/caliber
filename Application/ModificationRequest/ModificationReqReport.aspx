<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ModificationReqReport.aspx.vb" Inherits="ModificationRequest.ModificationReqReport" %>
                                ...
                                <asp:Table ID="SrhTbl" runat="server" HorizontalAlign="left" CellPadding="0" CssClass="SubTable"
                                    ...
                                    <asp:TableRow>
                                        <asp:TableCell CssClass="MainTD" ColumnSpan="1">
                                            <asp:Label ID="IsuCodeLbl" runat="server" Text="Modification Request Code"></asp:Label>
                                        </asp:TableCell>
                                        <asp:TableCell CssClass="MainTD" ColumnSpan="1">
                                        ...
                                        <asp:TableCell CssClass="MainTD" ColumnSpan="1">
                                            <asp:TextBox ID="IsuDescTxt" runat="server" Text="%" maxlength="50"></asp:TextBox>
                                        </asp:TableCell>
                                        <asp:TableCell CssClass="MainTD" ColumnSpan="1">
