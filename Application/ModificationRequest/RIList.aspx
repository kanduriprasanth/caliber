...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RIList.aspx.vb" Inherits="ModificationRequest.RIList" %>
            ...
            <asp:TableRow>
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow>
                            <asp:TableCell CssClass="MainTD" ColumnSpan="6" Width="50%">
                                <asp:LinkButton ID="CRLb" runat="server" Width="100%" Height="100%"></asp:LinkButton>
                            </asp:TableCell>
                            <asp:TableCell CssClass="HideRow" ColumnSpan="3" Width="50%">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="RecPerPageTxt" runat="server" AutoPostBack="False" CssClass="TxtCls"
                                    onkeypress="return IsDigit1(event);" Width="50px" MaxLength=3>20</asp:TextBox>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
                                <asp:Literal ID="PgNoLtrl" runat="server"></asp:Literal>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="PgNoTxt" runat="server" Width="50px" CssClass="TxtCls" AutoPostBack="False" MaxLength=5 onkeypress="return IsDigit1(event);">1</asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
