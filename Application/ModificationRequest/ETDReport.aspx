<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ETDReport.aspx.vb" Inherits="ModificationRequest.ETDReport" %>
                            ...
                            <asp:TableCell ColumnSpan="6">
                                <asp:Table ID="SrhTbl" runat="server" HorizontalAlign="left" CellPadding="0" CssClass="SubTable"
                                    ...
                                    <asp:TableRow>
                                        ...
                                        <asp:TableCell CssClass="MainTD" ColumnSpan="1">
                                            <asp:TextBox ID="IsuDescTxt" runat="server" MaxLength="50" Text="%"></asp:TextBox>
                                        </asp:TableCell>
                                        <asp:TableCell CssClass="MainTD" ColumnSpan="1">
