<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ETDIsuLogPopUp.aspx.vb" Inherits="ModificationRequest.ETDIsuLogPopUp" %>
                    ...
                    <div class="MainTd" style="height: 20px" id="Div1">
                        <table width="100%" cellspacing="0" cellpadding="0" align="center">
                            ...
                            <tr class="HideRow">
                             ...
                             <tr>
                                <td class="MainTd">
                                    <asp:Literal ID="Literal2" runat="server">Issue Status</asp:Literal>
                                </td>
                                <td class="MainTd" colspan ="3">
                                <asp:RadioButtonList ID="IssuStatusRdl" runat="server" RepeatDirection="Horizontal"
                                        CellPadding="0" CssClass="RBList" CellSpacing="0" Height="18px">
                                        <asp:ListItem Text="InProgress" Selected="true" Value="1"></asp:ListItem>
