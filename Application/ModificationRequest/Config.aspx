<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Config.aspx.vb" Inherits="ModificationRequest.Config" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD" ID="RegistrationTD" runat="server" ColumnSpan="2"></asp:TableCell>
                            <asp:TableCell CssClass="HideRow" ID="ChangeTD" runat="server"></asp:TableCell>
                            <asp:TableCell CssClass="HideRow" ColumnSpan="2" ID="StatusChgTD" runat="server"></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD" ID="RNarTD" runat="server" ColumnSpan="2"></asp:TableCell>
                            <asp:TableCell CssClass="HideRow" ID="MNarTD" runat="server"></asp:TableCell>
                            <asp:TableCell CssClass="HideRow" ColumnSpan="2" ID="SNarTD" runat="server"></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
