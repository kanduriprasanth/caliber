...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ModifyList.aspx.vb" Inherits="ModificationRequest.ModifyList" %>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="RecPerPageTxt" runat="server" AutoPostBack="False" CssClass="TxtCls"
                                    MaxLength="3" onkeypress="return IsDigit1(event);" Width="50px">10</asp:TextBox>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
