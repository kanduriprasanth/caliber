<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AuditeePopUp.aspx.vb" Inherits="DeptProcess.AuditeePopUp" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
    ...
    for(var k=0;k<<%=RecordCnt%>;k++)
    {
        ...
        opener.fnGetAuditeeListVal(KdIdVal,KdCodeVal,KfLableVal)
    }
	
	function fnCrCancel(){
		opener.fnGetAuditeeListVal('','','')
		window.self.close()
	}
