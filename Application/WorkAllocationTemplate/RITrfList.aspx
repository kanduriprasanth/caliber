...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RITrfList.aspx.vb" Inherits="WorkAllocationTemplate.RITrfList" %>
					...
					<asp:TableCell>
						...
						<asp:Table runat="server" CSSClass="SubTable" width="100%" CELLPADDING="0" cellspacing="1"
							...
							<asp:Tablerow>
								...
								<ASP:TABLECELL CssClass="MainTD">
									<ASP:TEXTBOX id="RecPerPageTxt" CssClass="TxtCls" Runat="server" AutoPostBack="False" Width="50px">10</ASP:TEXTBOX>
								</ASP:TABLECELL>
								<ASP:TABLECELL CssClass="MainTD">
