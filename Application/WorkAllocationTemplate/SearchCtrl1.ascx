<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl1.ascx.vb" Inherits="WorkAllocationTemplate.SearchCtrl1"  %>
...
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
				...
				<option value="2"> <%=HttpContext.Current.Application("ENB003_" & Session("LANG"))%></option>
			    <option value="1"> <%=HttpContext.Current.Application("ENB146_" & Session("LANG"))%></option>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD"><%=HttpContext.Current.Application("ENB003_" & Session("LANG"))%> Like &nbsp;<input class="TxtCls" id="SrchTxt2" maxLength="255"  style="WIDTH: 200px" accessKey="D" type="text" value ="%" name=SrchTxt2></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;<%=HttpContext.Current.Application("ENB146_" & Session("LANG"))%> 
            =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls"  id="SrchTxt1"  maxLength="30" style="WIDTH: 200px" accessKey="D" type="text"
							name="SrchTxt1" ></td>
				</tr>
			</table>
		</td>
