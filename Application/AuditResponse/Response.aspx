...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Response.aspx.vb" Inherits="AuditResponse.Response"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>reponse List</title>
						...
						<ASP:TABLE id="Table2" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
							...
							<ASP:TABLEROW>
								<ASP:TABLECELL CSSClass="MainTD" ColumnSpan="6">
									<uc1:SearchCtrl4 id="SearchCtrl4" runat="server"></uc1:SearchCtrl4>
								</ASP:TABLECELL>
							</ASP:TABLEROW>
