<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Config.aspx.vb" Inherits="AuditResponse.Config" %>
						...
						<asp:Table runat="server" CSSClass="SubTable" width="100%" CELLPADDING="0" cellspacing="1"
							...
							<asp:TableRow>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:checkbox id="isEsignAtCreatInit" enabled="false" runat="server"></asp:checkbox>
								</asp:TableCell>
								<asp:TableCell CssClass="MainTD">
									<asp:checkbox id="isEsignAtModifyInit"  enabled="false" runat="server"></asp:checkbox>
								</asp:TableCell>
								<asp:TableCell CssClass="MainTD">
							...
							<asp:TableRow>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:dropdownlist enabled="false" id="NARAtModify" runat="server" Width="50px">
										<asp:ListItem Value="0">0</asp:ListItem>
										<asp:ListItem Value="1">1</asp:ListItem>
										<asp:ListItem Value="2">2</asp:ListItem>
										<asp:ListItem Value="3">3</asp:ListItem>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:dropdownlist id="NARAtStatusChange" Enabled="false" runat="server" Width="50px">
										<asp:ListItem Value="0">0</asp:ListItem>
										<asp:ListItem Value="1">1</asp:ListItem>
										<asp:ListItem Value="2">2</asp:ListItem>
										<asp:ListItem Value="3">3</asp:ListItem>
