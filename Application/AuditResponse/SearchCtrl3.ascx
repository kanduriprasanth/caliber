...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl3.ascx.vb" Inherits="AuditResponse.SearchCtrl3" %>
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
			<option value="0" selected>Top 250 Records</option>
				<option value="2"> Audit Response Code </option>
				<option value="4"> Department/Site </option>
				<option value="5"> Vendor </option>
				<option value="6"> Item(s) </option>
			    <option value="3"> Initiated Date</option>
			<%--<option value="1"> Header Code</option>--%>
			</SELECT>
		</td>
	</tr>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Audit Response Code Like &nbsp;<input class="TxtCls" id="SrchTxt2" style="WIDTH: 200px" accessKey="D" type="text" maxLength="50"
		...
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Department/Site Like &nbsp;<input class="TxtCls" id="SrchTxt4" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
							name="SrchTxt4"  value='%'></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr class="HideRow" id="SrchTr5">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Vendor Like &nbsp;<input class="TxtCls" id="SrchTxt5" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
							name="SrchTxt5"  value='%'></td>
				</tr>
			</table>
		</td>
	</tr>
		...
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Item(s) Like &nbsp;<input class="TxtCls" id="SrchTxt6" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
							name="SrchTxt6"  value='%'></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr class="HideRow" id="SrchTr3">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD" >Initiated Between&nbsp;&nbsp;&nbsp;&nbsp;<uc1:calibercalender id="FromDate" runat="server"></uc1:calibercalender>
						And
	...
	<tr class="HideRow">
		<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl3<%=UniqeIDSep%>FromDate<%=UniqeIDSep%>CalDateVal,SearchCtrl3<%=UniqeIDSep%>ToDate<%=UniqeIDSep%>CalDateVal,SrchTxt4,SrchTxt5,SrchTxt6" name="SrchObjIds">	
...
function HideAllSrchTypes(){
    ...
    var ObjId
    for(i=1;i<SrchCnt;i++){
     ObjId="SrchTr" + document.all("SearchTypeDD")[i].value
...
function ResetSearchState(){
   ...
   var datval,curDateVal
    var Obj=document.getElementById("SearchCtrl3_SearchTxt")// get Search Text value
   
 	SearchTxtVal= Obj.value
 	
 	Obj=document.getElementById("SearchCtrl3_SearchType")//get search type value
	SearchTypeVal=Obj.value

 	Obj=document.getElementById("SearchCtrl3_ToDayDate")// get current date value
	...
	SrchObjIdAry=SrchObjIdVal.split(',')
		...
		if((SearchTxtVal!='')){ // reset values on page refresh /re-load
			...
			datAry=datval.split('/')
			obj=document.getElementById("SearchCtrl3_FromDate_CalDateDisplay")
			...
			var datAry =new Array()
			datAry=datval.split('/')
			obj=document.getElementById("SearchCtrl3_ToDate_CalDateDisplay")
			GetLocalizedDate(datAry[0], datAry[1], datAry[2],obj)
			}
...
function SetSearchTxt(){
	...
	if(SrchObjIdVal!=''){
		...
		var Obj=document.getElementById("SearchCtrl3_SearchTxt") //set search text with  '$*$' as seperator
		Obj.value=SrchValAry.join('$*$')
		Obj=document.getElementById("SearchCtrl3_SearchType")
