...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl2.ascx.vb" Inherits="AuditResponse.SearchCtrl2" %>
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
			<option value="0" selected>Top 250 Records</option>
				<option value="2"> Audit Observation Code </option>
	...
	<tr class="HideRow" id="SrchTr4">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Department/Site Like &nbsp;<input class="TxtCls" id="SrchTxt3" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
							name="SrchTxt3"  value='%'></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr class="HideRow" id="SrchTr5">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Vendor Like &nbsp;<input class="TxtCls" id="SrchTxt4" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
		...
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Item(s) Like &nbsp;<input class="TxtCls" id="SrchTxt5" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
		...
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Audit Observation Code Like &nbsp;<input class="TxtCls" id="SrchTxt2" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
	...
	<tr class="HideRow">
		<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl1<%=UniqeIDSep%>FromDate<%=UniqeIDSep%>CalDateVal,SearchCtrl1<%=UniqeIDSep%>ToDate<%=UniqeIDSep%>CalDateVal,SrchTxt3,SrchTxt4,SrchTxt5" name="SrchObjIds">	
