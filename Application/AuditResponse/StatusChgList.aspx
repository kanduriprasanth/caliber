...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="StatusChgList.aspx.vb" Inherits="AuditResponse.StatusChgList" %>
...
<asp:table CELLPADDING="0" CELLSPACING="0" BorderWidth="3" HorizontalAlign="center" cssclass="MainTable"
				WIDTH="100%" runat="server" id="Table1" EnableViewState=False >
						...
						<asp:Literal id="SubTitleLtrl" runat="server"></asp:Literal>
						  ...
						  <asp:TableRow >
							...
							<asp:Tablerow>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox ID="RecPerPageTxt" Runat="server" MaxLength="4" Width="50px" CssClass="TxtCls" AutoPostBack="False">10</asp:TextBox>
								</asp:TableCell>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox ID="PgNoTxt" Runat="server" MaxLength="4" Width="50px" CssClass="TxtCls" AutoPostBack="False">1</asp:TextBox>
								</asp:TableCell>
