<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Config.aspx.vb" Inherits="PlantAsg.Config" %>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <asp:Table ID="tt" runat="server" CssClass="MainTable" HorizontalAlign="center" BorderWidth="3"
