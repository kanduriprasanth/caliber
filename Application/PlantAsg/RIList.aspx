...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RIList.aspx.vb" Inherits="PlantAsg.RIList" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="RecPerPageTxt" MaxLength="3" runat="server" Width="50px" CssClass="TxtCls"
