<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SearchCtrl1.ascx.vb" Inherits="EffectivenessProtocol.SearchCtrl1" %>
<%@ Register TagPrefix="uc1" TagName="CaliberCalender" Src="../CaliberCommonCtrls/CaliberCalender.ascx" %>
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center" border="0">
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
			    ...
			    <option value="1">   <%=Application("QMS062_" & "0")%></option>
				<option value="2">   <%=Application("QMS042_" & "0")%></option>
				<option value="3"> Closed On </option>
			</SELECT>
		</td>
	</tr>
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD"><%=Application("QMS042_" & "0")%> Like &nbsp;<input class="TxtCls" id="SrchTxt2" maxLength="25"  style="WIDTH: 200px" accessKey="D" type="text"
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;<%=Application("QMS062_" & "0")%> 
            Like&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls"  id="SrchTxt1"  maxLength="50" style="WIDTH: 200px" accessKey="D" type="text"
