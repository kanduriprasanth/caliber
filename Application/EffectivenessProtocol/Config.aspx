<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Config.aspx.vb" Inherits="EffectivenessProtocol.Config" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="HideRow" ID="StatusChgTD" runat="server"></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="HideRow" ID="SNarTD" runat="server"></asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
