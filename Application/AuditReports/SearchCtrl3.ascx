<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SearchCtrl3.ascx.vb" Inherits="AuditReports.SearchCtrl3" %>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD"> Audit Description Like &nbsp;<input class="TxtCls" id="SrchTxt2" style="WIDTH: 200px" accessKey="D" type="text"
