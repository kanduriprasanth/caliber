<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VndrSummry.aspx.vb" Inherits="AuditReports.VndrSummry" %>
...
<head>
    ...
    <script language="javascript">
        ...
        {
            SetPopDimensions()
            var pageURL = "WrdFrmatRpt.aspx?Type=3&RgsAId=" + document.getElementById("PAIdTxt_" + i).value + "&RgsBId=" + document.getElementById("PBIdTxt_" + i).value
        ...
        <asp:Table ID="Table1" runat="server" CssClass="MainTable" HorizontalAlign="center"
            ...
            <asp:TableRow Height="20">
                <asp:TableCell CssClass="MainHead">
                    <asp:Literal ID="MainTitleLtrl" runat="server">Vendor Audit Summary Report</asp:Literal>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
