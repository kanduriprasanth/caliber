<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdtPropsalList.aspx.vb" Inherits="AuditReports.AdtPropsalList" %>

<%@ Register TagPrefix="uc1" TagName="SearchCtrl3" Src="SearchCtrl3.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Audit Proposal List</title>
			...
			<asp:table id="Table1" runat="server" cssclass="MainTable" HorizontalAlign="center" BorderWidth="3"
				...
				<ASP:TABLEROW Height="20">
					<ASP:TABLECELL CssClass="MainHead">
						<ASP:LITERAL id="MainTitleLtrl" Runat="server">Audit Proposal List</ASP:LITERAL>
					</ASP:TABLECELL>
				</ASP:TABLEROW>
				<ASP:TABLEROW>
