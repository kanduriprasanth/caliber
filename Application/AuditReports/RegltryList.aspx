<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RegltryList.aspx.vb" Inherits="AuditReports.RegltryList" %>
...
<head>
    ...
    <script language="javascript">
        ...
        {
            SetPopDimensions()
            var pageURL = "WrdFrmatRpt.aspx?Type=2&RgsAId=" + document.getElementById("PAIdTxt_" + i).value + "&RgsBId=" + document.getElementById("PBIdTxt_" + i).value
        ...
        <asp:Table ID="Table1" runat="server" CssClass="MainTable" HorizontalAlign="center"
            ...
            <asp:TableRow Height="20">
                <asp:TableCell CssClass="MainHead">
                    <asp:Literal ID="MainTitleLtrl" runat="server">External Audit Summary Report</asp:Literal>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
