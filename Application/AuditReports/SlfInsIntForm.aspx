<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SlfInsIntForm.aspx.vb" Inherits="AuditReports.SlfInsIntForm" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>Self Inspection Intimation Form</title>
        ...
        <asp:Table ID="Table1" runat="server" CssClass="MainTable" HorizontalAlign="center"
            ...
            <asp:TableRow Height="20">
                <asp:TableCell CssClass="MainHead">
                    <asp:Literal ID="MainTitleLtrl" runat="server">Self Inspection Intimation Form</asp:Literal>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
             ...
             <asp:TableRow CssClass="MainFoot">
                <asp:TableCell CssClass="MainHead">
                    <input type="button" id="ClsBtn" value="Back" class="ButCls" onMouseOver="this.className='ButOCls'"
