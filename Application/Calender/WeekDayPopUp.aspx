<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WeekDayPopUp.aspx.vb" Inherits="Calender.WeekDayPopUp" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>WeekDay List</title>
	...
	<body MS_POSITIONING="GridLayout" >
		<form id="Form1" method="post" runat="server">
			<TABLE class="MainTable" height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center"
				...
				<!-- MAIN HEADER -->
				<TR class="SubHead">
					<TD class="MainHead">WeekDay List</TD>
				</TR>
				<TR>
					<TD>
 ...
 var flag=false
  	...
  	function fnCrGetCode()
	{
	    ...
	    if (Lblvalue=='') document.getElementById("RBVal").value =Lblvalue
		   ...
		   opener.fnSetVal_Chklist(KfLableVal)
