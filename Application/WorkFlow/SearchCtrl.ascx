<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl.ascx.vb"
    Inherits="WorkFlow.SearchCtrl"%>
...
<table class="SubTable" id="Table1" style="width: 100%" cellspacing="1" cellpadding="0"
    ...
    <tr>
        <td class="SubHeadTD" colspan="2" align="left">
            ...
            <select id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
                ...
                <option value="1">
                    <%=HttpContext.Current.Application("ENB002_" & "0")%>
                </option>
                <option value="2">
                    <%=HttpContext.Current.Application("ENB003_" & "0")%>
                </option>
        ...
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                        <%=HttpContext.Current.Application("ENB003_" & "0")%>
                        Like &nbsp;<input class="TxtCls" id="SrchTxt2" maxlength="255" style="width: 200px"
                            accesskey="D" type="text" value='%' name="SrchTxt2"></td>
                </tr>
            </table>
        </td>
    </tr>
        ...
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                        &nbsp;<%=HttpContext.Current.Application("ENB002_" & "0")%>
                        =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls" id="SrchTxt1" maxlength="30"
                            style="width: 200px" accesskey="D" type="text" name="SrchTxt1"></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr class="HideRow">
        <td class="MainTd" colspan="2">
            <input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl1<%=UniqeIDSep%>FromDate<%=UniqeIDSep%>CalDateVal,SearchCtrl1<%=UniqeIDSep%>ToDate<%=UniqeIDSep%>CalDateVal,SrchTxt4"
                name="SrchObjIds">
