<%@ Page Language="vb" AutoEventWireup="false" Codebehind="App.aspx.vb" Inherits="WorkFlow.App" %>
...
var tmp="<%=Request.QueryString("AType")%>";
if(tmp=='S')
document.all('Approve_1').disabled=true //As per ravi sir instruction
else
document.all('Approve_2').disabled=true 
//document.all('Approve_1').disabled=true
//}
