...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ExistingList.aspx.vb"
    Inherits="WorkFlow.ExistingList" %>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="RecPerPageTxt" CssClass="TxtCls" runat="server" AutoPostBack="False"
                                    Width="50px" onkeypress="return IsDigit1(event);" MaxLength ="3">10</asp:TextBox>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
