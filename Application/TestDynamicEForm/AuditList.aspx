...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AuditList.aspx.vb" Inherits="TestDynamicEForm.AuditList" %>
					...
					<ASP:TABLECELL> <!-----------Base table------------->
						<ASP:TABLE id="CrTopTable" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
							...
							<ASP:TABLEROW>
								...
								<ASP:TABLECELL CssClass="MainTD">
									<ASP:TEXTBOX id="RecPerPageTxt" CssClass="TxtCls" Runat="server" MaxLength="3" AutoPostBack="False" Width="50px">10</ASP:TEXTBOX>
								</ASP:TABLECELL>
								<ASP:TABLECELL CssClass="MainTD">
