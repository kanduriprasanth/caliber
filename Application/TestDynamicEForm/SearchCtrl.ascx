<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl.ascx.vb" Inherits="TestDynamicEForm.SearchCtrl" %>
...
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
			    ...
			    <option value="1"> <%=HttpContext.Current.Application("ENB265_" & "0")%> </option>
				<%--<option value="2"> <%=HttpContext.Current.Application("A0125_" & "0")%> </option>--%>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD"><%=HttpContext.Current.Application("A0125_" & "0")%> Like &nbsp;<input class="TxtCls" id="SrchTxt2" maxLength="25"  style="WIDTH: 200px" accessKey="D" type="text"
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;<%=HttpContext.Current.Application("ENB265_" & "0")%>
	...
	<tr class="HideRow">
		<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SrchTxt2,<%=me.UniqueID%><%=UniqeIDSep%>FromDate<%=UniqeIDSep%>CalDateVal,<%=me.UniqueID%><%=UniqeIDSep%>ToDate<%=UniqeIDSep%>CalDateVal,SrchTxt4" name="SrchObjIds">
