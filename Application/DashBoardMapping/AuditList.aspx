...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AuditList.aspx.vb" Inherits="DashBoardMapping.AuditList" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table ID="CrTopTable" runat="server" HorizontalAlign="center" CellPadding="0"
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="RecPerPageTxt" CssClass="TxtCls" runat="server" MaxLength="3" AutoPostBack="False"
