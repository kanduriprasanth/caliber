<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InchargeList.aspx.vb" Inherits="DashBoardMapping.InchargeList" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
	...
	{ 
        ...
        opener.fnSetuserValue(UserIdVal,UserNameVal,UserCodeVal)
	}
