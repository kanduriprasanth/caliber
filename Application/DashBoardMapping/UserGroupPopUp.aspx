<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UserGroupPopUp.aspx.vb" Inherits="DashBoardMapping.UserGroupPopUp" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
	...
	{ 	
            ...
            var UserGrpID=document.getElementById("UserGrpID"+ RowCnt).innerHTML	
            var UserGrpCode=document.getElementById("UserGrpCode"+ RowCnt).innerHTML
            var UserGrpUcode=document.getElementById("UserGrpUcode"+ RowCnt).innerHTML
		    var UserGrpDesc=document.getElementById("UserGrpDesc"+ RowCnt).innerHTML

            opener.fnSetuserGrpValue(UserGrpID,UserGrpCode,UserGrpDesc)        //RevAppUCodeVal     
            document.getElementById("RBVal").value = UserGrpID
   
		   	
	}
	function fnCrCancel(){
		opener.fnSetuserGrpValue('','','')
		window.self.close()
	}
