<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreationPopUp.aspx.vb" Inherits="Department.CreationPopUp" %>
							...
							<table width="100%" cellSpacing="0" cellPadding="0" align="center">
								...
								<tr>
									<td class="MainTd" colspan="2">
										...
										<asp:TextBox id="FindTxt" runat="server" Width="180px" CssClass='TxtCls' MaxLength='26'>%</asp:TextBox>
									</td>
									<td class="MainTd" colspan="2">
