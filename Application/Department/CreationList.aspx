<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreationList.aspx.vb" Inherits="Department.CreationList" %>
									...
									<TABLE Align="center" CELLPADDING="0" class="SubTable" cellspacing="1" width="100%">
										<tr>
											<td Style="WIDTH:150px" class="MainTd">
												Kf &nbsp; <INPUT type="button" onclick="fnOpenCrPopUp()" class='RsnPUP' style="HEIGHT:20px">
											</td>
											<td class="MainTd">
