...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ModifyList.aspx.vb" Inherits="DeptUserGrpMapping.ModifyList" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table ID="CrTopTable" runat="server" HorizontalAlign="center" CellPadding="0"
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="RecPerPageTxt" CssClass="TxtCls" MaxLength="3" runat="server" AutoPostBack="False"
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="PgNoTxt" CssClass="TxtCls" runat="server" MaxLength="5" AutoPostBack="False" Width="50px">1</asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
