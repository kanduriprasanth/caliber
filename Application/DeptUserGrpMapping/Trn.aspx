<%@ Page Language="vb" AutoEventWireup="false" enableEventValidation="false" Codebehind="Trn.aspx.vb" Inherits="DeptUserGrpMapping.Trn" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:DropDownList ID="DeptDDL" AutoPostBack="true" runat="server" >
                                </asp:DropDownList>
                                <asp:Label ID="DeptLbl" runat="server" CssClass="HideRow"></asp:Label>
                                <asp:TextBox ID ="DeptTxt" runat ="server" CssClass ="HideRow"></asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell ID="UserGroupsTd" ColumnSpan="6" CssClass="SubHeadTd"> </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
