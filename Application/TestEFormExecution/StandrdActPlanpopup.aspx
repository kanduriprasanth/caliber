<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StandrdActPlanpopup.aspx.vb" Inherits="TestEFormExecution.StandrdActPlanpopup" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Action Plan Title List </title>
	...
	<body MS_POSITIONING="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
		<form id="Form1" method="post" runat="server">
			<TABLE class="MainTable" height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center"
				...
				<!-- MAIN HEADER -->
				<TR class="SubHead">
					<TD class="MainHead">Action Plan Title List </TD>
				</TR>
				<TR>
					<TD>
 ...
 var flag=false
	...
	{ 
		    ...
		    var KdIdVal=document.all("KdId"+ RowCnt).innerText
		   	opener.SetCaption(<%=ActPlnCnt%>,KfLableVal )
		   	flag=true
	}
	function fnCrCancel(){
	
		opener.SetCaption(<%=ActPlnCnt%>,'')
		window.self.close()
