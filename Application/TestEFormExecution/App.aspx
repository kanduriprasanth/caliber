<%@ Page Language="vb" AutoEventWireup="false" Codebehind="App.aspx.vb" Inherits="TestEFormExecution.App" %>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="0"
                        ...
                        <asp:TableRow CssClass="HideRow">
                            <asp:TableCell ColumnSpan="2" ID="ValidatorsTd" runat="server">
                                ...
                                <asp:CustomValidator ID="Val01" runat="server" ClientValidationFunction="Val_Cus"></asp:CustomValidator>
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                </asp:TableCell>
