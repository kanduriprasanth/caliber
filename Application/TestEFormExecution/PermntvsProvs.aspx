<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PermntvsProvs.aspx.vb" Inherits="TestEFormExecution.PlanClosureList" %>
						...
						<ASP:TABLE id="CrTopTable" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
							...
							<asp:TableRow>
								<asp:TableCell CSSClass="MainTD" ColumnSpan="6">
									<uc1:SearchCtrl id="SearchCtrl2" runat="server"></uc1:SearchCtrl>
								</asp:TableCell>
							</asp:TableRow>
