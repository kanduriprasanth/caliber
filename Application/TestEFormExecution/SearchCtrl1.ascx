<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl1.ascx.vb" Inherits="TestEFormExecution.SearchCtrl1"  %>
...
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
			    ...
			    <option value="1"> <%=HttpContext.Current.Application("ENB204_" & "0")%></option>
				<option value="2"> <%=HttpContext.Current.Application("ENB105_" & "0")%></option>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD"><%=HttpContext.Current.Application("ENB105_" & "0")%> Like &nbsp;<input class="TxtCls" id="SrchTxt2" maxLength="500"  style="WIDTH: 200px" accessKey="D" type="text"
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;<%=HttpContext.Current.Application("ENB204_" & "0")%> 
            =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls"  id="SrchTxt1"  maxLength="500" style="WIDTH: 200px" accessKey="D" type="text"
							name="SrchTxt1" ></td>
				</tr>
			</table>
		</td>
