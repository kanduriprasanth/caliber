<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl2.ascx.vb" Inherits="TestEFormExecution.SearchCtrl2"  %>
...
<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
			    ...
			    <option value="1"> Permanent Number</option>
				<option value="2">Department</option>
				<option value="3"> Initiated On</option>
				<option value="4"> Temporary Number</option>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Department Like &nbsp;<input class="TxtCls" id="SrchTxt2" maxLength="25"  style="WIDTH: 200px" accessKey="D" type="text"
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;Permanent Number Like
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls"  id="SrchTxt1"  maxLength="50" style="WIDTH: 200px" accessKey="D" type="text"
	...
	<tr class="HideRow" id="SrchTr4">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;Temporary Number Like
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls"  id="SrchTxt4"  maxLength="50" style="WIDTH: 200px" accessKey="D" type="text"
						value='%' name="SrchTxt4" ></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr class="HideRow">
		<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl2<%=UniqeIDSep%>FromDate<%=UniqeIDSep%>CalDateVal,SearchCtrl2<%=UniqeIDSep%>ToDate<%=UniqeIDSep%>CalDateVal,SrchTxt4" name="SrchObjIds">
...
function ResetSearchState(){
   var datval,curDateVal
    var Obj=document.getElementById("SearchCtrl2_SearchTxt")// get Search Text value
 	SearchTxtVal= Obj.value
 	
 	Obj=document.getElementById("SearchCtrl2_SearchType")//get search type value
	SearchTypeVal=Obj.value
 	Obj=document.getElementById("SearchCtrl2_ToDayDate")// get current date value
	...
	SrchObjIdAry=SrchObjIdVal.split(',')
		...
		if((SearchTxtVal!='')){ // reset values on page refresh /re-load
			...
			datAry=datval.split('/')
			obj=document.getElementById("SearchCtrl2_FromDate_CalDateDisplay")
			...
			var datAry =new Array()
			datAry=datval.split('/')
			obj=document.getElementById("SearchCtrl2_ToDate_CalDateDisplay")
			GetLocalizedDate(datAry[0], datAry[1], datAry[2],obj)
			}
...
function SetSearchTxt(){
	...
	if(SrchObjIdVal!=''){
		...
		var Obj=document.getElementById("SearchCtrl2_SearchTxt") //set search text with  '$*$' as seperator
		Obj.value=SrchValAry.join('$*$')
		Obj=document.getElementById("SearchCtrl2_SearchType")
