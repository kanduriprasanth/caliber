...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AuditList.aspx.vb" Inherits="LocWrkAllTyp2.AuditList" %>
					...
					<ASP:TABLECELL> <!-----------Base table------------->
						<ASP:TABLE id="CrTopTable" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
							...
							<ASP:TABLEROW>
								...
								<ASP:TABLECELL CssClass="MainTD">
									<ASP:TEXTBOX id="RecPerPageTxt" CssClass="TxtCls" Runat="server" AutoPostBack="False" Width="50px"  MaxLength="3">10</ASP:TEXTBOX>
								</ASP:TABLECELL>
								<ASP:TABLECELL CssClass="MainTD">
									<ASP:LITERAL id="PgNoLtrl" Runat="server"></ASP:LITERAL>
								</ASP:TABLECELL>
								<ASP:TABLECELL CssClass="MainTD">
									<ASP:TEXTBOX id="PgNoTxt" CssClass="TxtCls" Runat="server" AutoPostBack="False" Width="50px" MaxLength="3">1</ASP:TEXTBOX>
								</ASP:TABLECELL>
