<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FldItemList.aspx.vb" Inherits="LocWrkAllTyp2.FldItemList" %>
    ...
    //    setTimeout("DisplayInitialRecord()",100);
        ...
        function FnOpenAuditPage(i)  
        {
         ShowMask()
            ...
            var pageURL = "FldItemAudDisplay.aspx?FldId=" + FldId + "&FldName=" + FldName
