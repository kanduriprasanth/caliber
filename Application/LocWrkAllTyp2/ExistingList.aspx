...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ExistingList.aspx.vb" Inherits="LocWrkAllTyp2.ExistingList" %>
					...
					<ASP:TABLECELL> <!-----------Base table------------->
						<ASP:TABLE id="CrTopTable" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
							...
							<ASP:TABLEROW>
								...
								<ASP:TABLECELL CssClass="MainTD">
									<ASP:TEXTBOX id="PgNoTxt" CssClass="TxtCls" MaxLength="3" Runat="server" AutoPostBack="False" Width="50px">1</ASP:TEXTBOX>
								</ASP:TABLECELL>
							</ASP:TABLEROW>
							<ASP:TABLEROW>
