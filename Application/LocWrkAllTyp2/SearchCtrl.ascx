...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl.ascx.vb" Inherits="LocWrkAllTyp2.SearchCtrl"%>
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
				...
				<option value="2">  Control Name</option>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD">Control Name Like &nbsp;<input class="TxtCls" id="SrchTxt2" style="WIDTH: 200px" accessKey="D" type="text" maxLength="26"
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
            ...
            =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls" id="SrchTxt1" style="WIDTH: 250px" accessKey="D" type="text" maxLength="150"
							name="SrchTxt1" ></td>
				</tr>
			</table>
		</td>
	...
	<tr class="HideRow">
		<%--<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl1:FromDate:CalDateVal,SearchCtrl1:ToDate:CalDateVal"
				name="SrchObjIds">--%>
			<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl1<%=me.UniqeIDSep%>FromDate<%=me.UniqeIDSep%>CalDateVal,SearchCtrl1<%=me.UniqeIDSep%>ToDate<%=me.UniqeIDSep%>CalDateVal" name="SrchObjIds">	 
