...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AppList.aspx.vb" Inherits="LocWrkAllTyp2.AppList" %>
					...
					<asp:TableCell>
						...
						<asp:Table runat="server" CSSClass="SubTable" width="100%" CELLPADDING="0" cellspacing="1"
							...
							<asp:Tablerow>
								...
								<asp:TableCell CssClass="MainTD">
									<asp:TextBox ID="PgNoTxt" Runat="server" Width="30px" MaxLength="3" CssClass="TxtCls" AutoPostBack="False">1</asp:TextBox>
								</asp:TableCell>
							</asp:Tablerow>
							<asp:TableRow>
