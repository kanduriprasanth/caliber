<%@ Control Language="C#" AutoEventWireup="true" Codebehind="SearchCtrl1.ascx.cs"
    Inherits="ImageManipulation.SearchCtrl1" %>
    ...
    <tr class="HideRow" id="SrchTr2">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                        Description Like &nbsp;<input class="TxtCls" id="SrchTxt2" style="width: 200px" accesskey="D"
    ...
    <tr class="HideRow" id="SrchTr1">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                        &nbsp;Image Name =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls" id="SrchTxt1"
                            style="width: 200px" accesskey="D" type="text" maxlength="30" name="SrchTxt1"></td>
                </tr>
            </table>
        </td>
    </tr>
