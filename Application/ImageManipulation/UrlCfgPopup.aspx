<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UrlCfgPopup.aspx.cs" Inherits="ImageManipulation.UrlCfgPopup" %>
...
<script language="javascript">
    ...
    { 
        var MenuName = document.all("MenuName" + RowCnt).innerText 
        var MenuUrl=document.getElementById("MenuUrl"+RowCnt).innerText
        
        document.getElementById("RBVal").innerHTML = MenuName

        opener.fnSetActions(MenuName,MenuUrl)
    }
    function fnCrCancel()
    {
        opener.fnSetActions('','')
