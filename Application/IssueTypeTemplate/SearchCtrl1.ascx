<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl1.ascx.vb" Inherits="IssueTypeTemplate.SearchCtrl1"  %>
...
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
			    ...
			    <option value="1"> <%=HttpContext.Current.Application("ENB146_" & "0")%></option>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
				<td class="MainTD"><%=HttpContext.Current.Application("ENB003_" & "0")%> Like &nbsp;<input class="TxtCls" id="SrchTxt2" maxLength="255"  style="WIDTH: 200px" accessKey="D" type="text" value ="%" name=SrchTxt2></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;<%=HttpContext.Current.Application("ENB146_" & "0")%> 
