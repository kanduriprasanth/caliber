<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl2.ascx.vb" Inherits="WorkTransfer.SearchCtrl2"  %>
    ...
    <tr>
        <td class="SubHeadTD" colspan="2" align="left">
            ...
            <select id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
                ...
                <option value="2"><%=HttpContext.Current.Application("QAMS230_" & "0")%></option>
                <option value="1"><%=HttpContext.Current.Application("QAMS229_" & "0")%></option>
                <option value="3">Initiated On</option>
                <option value="4"><%=HttpContext.Current.Application("QAMS231_" & "0")%></option>
    ...
    <tr class="HideRow" id="SrchTr2">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                         <%=HttpContext.Current.Application("QAMS230_" & "0")%>
                        Like &nbsp;<input class="TxtCls" id="SrchTxt2" style="width: 200px" accesskey="D"
                            type="text" maxlength="250" value="%" name="SrchTxt2"></td>
                </tr>
            </table>
        </td>
    </tr>
    <tr class="HideRow" id="SrchTr1">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                        &nbsp; <%=HttpContext.Current.Application("QAMS229_" & "0")%>
                        =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls" id="SrchTxt1" style="width: 200px"
                            accesskey="D" type="text" maxlength="30" name="SrchTxt1"></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr class="HideRow" id="SrchTr4">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                         <%=HttpContext.Current.Application("QAMS231_" & "0")%>
                        Like &nbsp;<input class="TxtCls" id="SrchTxt4" style="width: 200px" accesskey="D"
                            type="text" maxlength="250" value="%" name="SrchTxt4"></td>
                </tr>
            </table>
        </td>
    </tr>
