<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Config.aspx.vb" Inherits="WorkTransfer.Config" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:CheckBox ID="isEsignAtModifyInit" runat="server" Enabled=false ></asp:CheckBox>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:CheckBox ID="isEsignAtModifyAppr" runat="server" Enabled=false ></asp:CheckBox>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:DropDownList ID="NARAtModify" runat="server" Width="50px" Enabled=false >
                                    <asp:ListItem Value="0">0</asp:ListItem>
                                    <asp:ListItem Value="1">1</asp:ListItem>
                                    <asp:ListItem Value="2">2</asp:ListItem>
                                    <asp:ListItem Value="3">3</asp:ListItem>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:CheckBox ID="IMail" runat="server" Enabled=false ></asp:CheckBox>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:DropDownList ID="MoGrpId" runat="server" Width="50px" Enabled=false >
                                    <asp:ListItem Value="0">NA</asp:ListItem>
                                </asp:DropDownList>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
