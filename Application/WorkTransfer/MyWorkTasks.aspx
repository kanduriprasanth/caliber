<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MyWorkTasks.aspx.vb" Inherits="WorkTransfer.MyWorkTasks" %>
                    ...
                    <asp:TableRow>
                     ...
                     <asp:TableRow ID="TableRow1" runat="Server">
                        <asp:TableCell CssClass="MainTD" ColumnSpan="3">
                           <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                                HorizontalAlign="center" ID="PendingWorksList">
                                <asp:TableRow>
                                <asp:TableCell ID="TaskTd" CssClass="MainTD" runat="server">                               
                                </asp:TableCell>
