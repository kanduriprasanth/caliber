<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RegulatoryAdtList.aspx.vb" Inherits="SelfInspection.RegulatoryAdtList" %>
        ...
        <asp:Table ID="Table1" runat="server" CssClass="MainTable" HorizontalAlign="center"
            ...
            <asp:TableRow Height="20" >
                <asp:TableCell CssClass="MainHead">
                    <asp:Literal ID="MainTitleLtrl" runat="server">External Agency Audit Plan Schedule</asp:Literal>
                        ...
                        <asp:Table ID="Table2" runat="server" HorizontalAlign="center" BackColor="#f7ffff"  
                            ...
                            <asp:TableRow Width="100%">
                                <asp:TableCell VerticalAlign=Middle HorizontalAlign=Center >
                                    <asp:ImageButton Visible="true"  ID="Prev" Style="position: absolute;"
                                        runat="server" ImageUrl="../IMAGES/previousoccupancy.jpg" />
                                </asp:TableCell>
                                ...
                                <asp:TableCell VerticalAlign=Middle HorizontalAlign=Center >
                                    <asp:ImageButton Visible="true" ID="Nxt" Style="position: absolute;"
                                        runat="server" ImageUrl="../IMAGES/nextoccupancy.jpg" />
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
                    </div>
