<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UsrGrpPopUp.aspx.vb" Inherits="SelfInspection.UsrGrpPopUp" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
	...
	{ 
        ...
        opener.fnGetUserrpVal(KdIdVal,KfLableVal,KdDesVal,<%=Request.QueryString("iCnt")%>,<%=Request.QueryString("jCnt")%>)
    }
	
	function fnCrCancel(){
		opener.fnGetUserrpVal('','','',<%=Request.QueryString("iCnt")%>,<%=Request.QueryString("jCnt")%>)
		window.self.close()
	}
