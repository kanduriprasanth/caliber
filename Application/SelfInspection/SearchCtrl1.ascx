<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl1.ascx.vb" Inherits="SelfInspection.SearchCtrl1" %>
		...
		<td class="SubHeadTD" colSpan="2" align="left">&nbsp;&nbsp;Search 
			...
			<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD" >
				...
				<option value="1">
					...
					<option value="4">
					Vendor</option>
<%--					<option value="5">                  --Code related to Search option 5 is not commented in STP'S
					Item/Service</option>--%>
				<option value="3">
					Initiated Date</option>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				...
				<tr>
					<td class="MainTD">
						Audit Description Like&nbsp;&nbsp;&nbsp;<input class="TxtCls" id="SrchTxt2" style="WIDTH: 200px" accessKey="D" type="text" maxLength="50"
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				border="0">
				<tr>
					<td class="MainTD">&nbsp;Audit Code =&nbsp;&nbsp;&nbsp;&nbsp;<input class="TxtCls" id="SrchTxt1" style="WIDTH: 200px" accessKey="D" type="text" maxLength="250"
							 name="SrchTxt1"></td>
				</tr>
			</table>
		</td>
	...
	<tr class="HideRow" id="SrchTr4">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				...
				<tr>
					<td class="MainTD">
						Vendor Like&nbsp;&nbsp;&nbsp;<input class="TxtCls" id="Text1" style="WIDTH: 200px" accessKey="D" type="text" maxLength="50"
							value="%" name="SrchTxt3"></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr class="HideRow" id="SrchTr5">
		<td class="MainTd" colSpan="2">
			<table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				...
				<tr>
					<td class="MainTD">
						Item/Service Like&nbsp;&nbsp;&nbsp;<input class="TxtCls" id="Text2" style="WIDTH: 200px" accessKey="D" type="text" maxLength="50"
	...
	<tr class="HideRow">
		<%--<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl1:FromDate:CalDateVal,SearchCtrl1:ToDate:CalDateVal"
				name="SrchObjIds">--%>
				<td class="MainTd" colSpan="2"><input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl1<%=UniqeIDSep%>FromDate<%=UniqeIDSep%>CalDateVal,SearchCtrl1<%=UniqeIDSep%>ToDate<%=UniqeIDSep%>CalDateVal,SrchTxt3,SrchTxt4" name="SrchObjIds">	 
