<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SlfInsSchRpt.aspx.vb" Inherits="SelfInspection.SlfInsSchRpt" %>
					...
					<TD>
						<asp:Panel id="HeaderDiv" runat="server" Width="900" HorizontalAlign="Left" EnableViewState="False">
							...
							<asp:Table id="H2" style="FONT-SIZE: 10px; MARGIN-LEFT: 0px; FONT-FAMILY: Arial" Width="900"
								...
								<asp:TableRow>
									<asp:TableCell HorizontalAlign="Center" style="Width:900px;font-size:16;font-weight:bold;Padding:0px;Background-color:white;text-align:center">Self – Inspection Schedule</asp:TableCell>
								</asp:TableRow>
							</asp:Table>
						</asp:Panel>
