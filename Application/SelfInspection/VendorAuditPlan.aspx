<%@ Page Language="vb" AutoEventWireup="false" Codebehind="VendorAuditPlan.aspx.vb"
    Inherits="SelfInspection.VendorAuditPlan" %>
...
<head>
    ...
    {
        document.getElementById("VendorId").value=KdIdVal
        document.getElementById("VendorCodeTxt").value=KfLableVal 
        document.getElementById("VendorCodeLbl").innerHTML=KfLableVal 
    }     
                ...
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                        ...
                        <asp:TableRow ID="AuditTypeRow">
                            ...
                            <asp:TableCell CssClass="MainTD" ID="AdtTypeCapTD">Vendor Audit
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                        ...
                        <asp:TableRow ID="RegTr">
                            ...
                            <asp:TableCell CssClass="MainTD" ID="VendorCapTD">
                                <input type="button" id="VendorBtn" onclick="VendorPopUpFn()" title="Click Here"
                                    class='RsnPUP' style="height: 20px">
                                <asp:Label ID="VendorCodeLbl" runat="server"></asp:Label>
                                <asp:TextBox ID="VendorCodeTxt" runat="server" CssClass="hiderow"></asp:TextBox>
                                <asp:TextBox ID="TextBox1" runat="server" CssClass="hiderow"></asp:TextBox>
                                <asp:TextBox ID="VendorId" runat="server" CssClass="hiderow"></asp:TextBox>
