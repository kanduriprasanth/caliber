<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreationList.aspx.vb" Inherits="ApprovedVendor.CreationList" %>
...
function fnCrSetToCode(KfIdVal,KfLableVal,PrdCodeLblVal){
      var objId
      var obj
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:table CELLPADDING="0" CELLSPACING="0" BorderWidth="1" HorizontalAlign="center" cssclass="MainTable"
						...
						<ASP:TABLE id="CrTopTable" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
							...
							<ASP:TABLEROW>
								...
								<TABLE Align="center" CELLPADDING="0" class="SubTable" cellspacing="1" width="100%">
									<tr>
										<td Style="WIDTH:200px" class="MainTd"> Product / Material Name &nbsp;
								 ...
								 <tr>
										<td Style="WIDTH:150px" class="MainTd"> Product / Material Code &nbsp;
										 		
										 </td>
										<td class="MainTd">
											<asp:Label id="PrdCodeLbl" runat="server" CssClass="MainTd" ></asp:Label>
										</td>
								 </tr>
									<TR>
