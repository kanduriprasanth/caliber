<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CreationPopUp.aspx.vb" Inherits="ApprovedVendor.CreationPopUp" %>
	...
	<body MS_POSITIONING="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
		<form id="Form1" method="post" runat="server">
			<TABLE class="MainTable" height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center"
				...
				<!-- MAIN HEADER -->
				<TR>
					<TD class="MainHead">Product List</TD>
				</TR>
				<TR>
					<TD>
								...
								<Tr>
									...
									<td class="MainTd" colspan="3">
										<asp:RadioButtonList ID="SearchOptionRD" Runat="server" RepeatDirection="Horizontal" CellPadding="0"
											...
											<asp:ListItem Value="1" Selected="True">Product / Material Name</asp:ListItem>
											<asp:ListItem Value="2">Product / Material Code</asp:ListItem>
										</asp:RadioButtonList>
									</td>
								</Tr>
								<tr>
 ...
 var flag=false
	...
	{ 
		    ...
		    var KdIdVal=document.all("KdId"+ RowCnt).innerText
		     var PrdCodeLblVal=document.all("PrdCodeLbl"+ RowCnt).innerHTML
		       flag=true
		   	opener.fnCrSetToCode(KdIdVal,KfLableVal,PrdCodeLblVal )
	}
	function fnCrCancel(){
