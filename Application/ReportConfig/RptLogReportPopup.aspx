<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RptLogReportPopup.aspx.vb" Inherits="ReportConfig.RptLogReportPopup" %>
...
<body ms_positioning="GridLayout">
    <form id="Form1" method="post" runat="server">
        <table class="MainTable" height="100%" cellspacing="0" cellpadding="0" width="100%"
            ...
            <tr class="SubHead">
                <td class="MainHead">
                    <asp:Literal ID="MainTitleLtrl" runat="server"> Log Report Selection</asp:Literal></td>
            </tr>
            <tr>
