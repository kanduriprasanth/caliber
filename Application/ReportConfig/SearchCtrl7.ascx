<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SearchCtrl7.ascx.vb" Inherits="ReportConfig.SearchCtrl7" %>
...
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		<td class="HeadTD" colSpan="2" align="left">&nbsp;&nbsp;Search 
			By&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr class="HideRow" id="SrchTr1">
		<td class="MainTd" colSpan="2">
			<Table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				...
				<tr>
					<td class="MainTD">
						User Id Like&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="TxtCls" id="SrchTxt1" style="WIDTH: 200px" accessKey="D" type="text" maxLength="25"
							name="SrchTxt1" value='%'>
					</td>
				</tr>
			</Table>
	...
	<tr class="HideRow" id="SrchTr2">
		<td class="MainTd" colSpan="2">
			<Table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				...
				<tr>
					<td class="MainTD">
						User Name Like &nbsp; <input class="TxtCls" id="SrchTxt2" style="WIDTH: 200px" accessKey="D" type="text" maxLength="26"
							name="SrchTxt2"  value='%'>
					</td>
				</tr>
			</Table>
	...
	<tr class="HideRow" id="SrchTr3">
		<td class="MainTd" colSpan="2">
			<Table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				...
				<tr>
					<td class="MainTD">
						Role Like &nbsp;&nbsp; <input class="TxtCls" id="SrchTxt3" style="WIDTH: 200px" accessKey="D" type="text" maxLength="26"
							name="SrchTxt3"  value='%'>
					</td>
				</tr>
			</Table>
			...
			<Table class="SubTable" style="WIDTH: 100%" cellSpacing="1" cellPadding="0" align="center"
				...
				<tr class="HideRow">
					<td class="MainTd" colSpan="2">
						...
						<input type="hidden" value="SrchTxt1,SrchTxt2,SrchTxt3,SearchCtrl1<%=UniqeIDSep%>FromDate<%=UniqeIDSep%>CalDateVal,SearchCtrl1<%=UniqeIDSep%>ToDate<%=UniqeIDSep%>CalDateVal" name="SrchObjIds">
