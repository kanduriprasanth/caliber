<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Report.aspx.vb" Inherits="ReportConfig.Report" %>
...
<!--
    ...
    function OpenPopUp()
    {
        var pageURL = "CAPATrackSheet.aspx?RptType=" + <%=Category%> + "&AcplnCnfgId=" + <%=AcplnCnfgId%>
    ...
    function AssignUrl(ChartPos)
    {
        if(ChartPos==1)
        {           
            window.frames['TopChrtFrame'].location.href="<%=DBoardPath%>RptId=" + <%=ReportId%> + "&ChartType=" + "<%=ChartType%>" + "&ChartTitle=" + "<%=BookTitle%>" + "&ChartColName=" + "<%=ChartColName%>" + "&ChartVal=" + "<%=ChartVal%>" + "&ChartDType=" + "<%=ChartDType%>" + "&ChartOpStr=" + "<%=ChartOpStr%>" + "&ChartOpStr=" + <%=Cnt%> ;
        }
        else if(ChartPos==2)
        {            
            window.frames['BtmChartFrame'].location.href="<%=DBoardPath%>RptId=" + <%=ReportId%> + "&ChartType=" + "<%=ChartType%>" + "&ChartTitle=" + "<%=BookTitle%>" + "&ChartColName=" + "<%=ChartColName%>" + "&ChartVal=" + "<%=ChartVal%>" + "&ChartDType=" + "<%=ChartDType%>" + "&ChartOpStr=" + "<%=ChartOpStr%>" + "&Cnt=" + <%=Cnt%> ;
        }
    }
...
//                }
	...
	function write_to_excel(ExcelType1) {debugger
...
debugger
    ...
    //        Yseris=<%=Yseris%>
            ...
            var mytable = document.getElementById("DetTab");
            var rowCount = mytable.rows.length;
            var colCount = mytable.rows(1).cells.length;        
...
//            }
            ...
            ChartEndVal=ChartEndVal * 10
            var oChart=oBook.WorkSheets(1).chartObjects().Add(10, 318, 430, 250 + ChartEndVal).Chart
