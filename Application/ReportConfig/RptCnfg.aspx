<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RptCnfg.aspx.vb" Inherits="ReportConfig.RptCnfg" %>
                ...
                <asp:TableCell>
                    ...
                    <asp:Table runat="server" CssClass="SubTable" Width="100%" CellPadding="0" CellSpacing="1"
                                ...
                                <asp:Table ID="Table3" runat="server" BorderWidth="0" CellPadding="0" CellSpacing="1"
                                    ...
                                    <asp:TableRow ID="SplFilTr" CssClass="HideRow">
                                        ...
                                        <asp:TableCell CssClass="MainTD">
                                            <asp:RadioButtonList ID="SplFilRBL" onclick="FnShowHide()" runat="server" CssClass="RBList"
                        ...
                        <asp:TableRow ID="OptionRow" CssClass="HideRow">
                            ...
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="RwTxt" Width="50px" runat="server" CssClass="TxtCls" MaxLength="1"></asp:TextBox>
                            </asp:TableCell>
                            <asp:TableCell CssClass="MainTD">No. Of Column</asp:TableCell>
                            <asp:TableCell CssClass="MainTD">
                                <asp:TextBox ID="ColTxt" Width="50px" runat="server" CssClass="TxtCls" MaxLength="1"></asp:TextBox>
                            </asp:TableCell>
                        </asp:TableRow>
                        ...
                        <asp:TableRow ID="ChrtCnfgReq" CssClass="HideRow">
                            ...
                            <asp:TableCell CssClass="MainTD" ColumnSpan="5" ID="ChartReqTd">
                                <asp:RadioButtonList ID="ChrtReqRB" onclick="HideShowChrtTab()" CssClass="RBList"
                        ...
                        <asp:TableRow ID="ChartTr" CssClass="HideRow">
                            <asp:TableCell ColumnSpan="4">
                                <asp:Table ID="ChartCfgtab" runat="server" CssClass="HideRow" Width="100%" CellPadding="0"
                                    ...
                                    <asp:TableRow>
                                        <asp:TableCell ColumnSpan="2" ID="ChartCfg" CssClass="SubHeadTD" Style="font-weight: bold;"
                                    ...
                                    <asp:TableRow>
                                        <asp:TableCell ID="ClauseTd" CssClass="MainTD" Style="font-weight: bold;" Text="Clause"></asp:TableCell>
                                        <asp:TableCell CssClass="MainTD">
                                            <asp:DropDownList ID="ClauseDDL" runat="server">
...
//        document.getElementById("SelFieldTr").className = "HideRow"
    ...
    function ChkValidationForDateDDl(src,args)
    {
        args.IsValid=true;
        Page_IsValid=true;
        var Cnt=<%=TotalFldCnt%>;
        ...
        if(document.getElementById("RptTypRbl_1").checked==true)
        {
            for(var i=0; i<Cnt; i++)
            {
                if(document.getElementById("DateDDL_"+i)!=null)
                {
                    if(document.getElementById("DateDDL_"+i).value=="")
                    {
                        Flag=false;
                        break;
                    }
    ...
    function ChkValidationForPopUp(src,args)
    {
        args.IsValid=true;
        Page_IsValid=true;
        var Cnt=<%=TotalFldCnt%>;
        ...
        if(document.getElementById("RptTypRbl_1").checked==true)
        {
            for(var i=0; i<Cnt; i++)
            {
                if(document.getElementById("SpclTxt_"+i)!=null)
                {
                    if(document.getElementById("SpclTxt_"+i).value=="")
                    {
                        Flag=false;
                        break;
                    }
    ...
    function ChkValidationForSpclDDl(src,args)
    {
        args.IsValid=true;
        Page_IsValid=true;
        var Cnt=<%=TotalFldCnt%>;
        ...
        if(document.getElementById("RptTypRbl_1").checked==true)
        {
            for(var i=0; i<Cnt; i++)
            {
                if(document.getElementById("SpclDDl_"+i)!=null)
                {
                    if(document.getElementById("SpclDDl_"+i).value=="")
                    {
                        Flag=false;
                        break;
                    }
    ...
    function ChkValidationForSpclTxt(src,args)
    {
        args.IsValid=true;
        Page_IsValid=true;
        var Cnt=<%=TotalFldCnt%>;
    ...
    {
        if(document.getElementById("RptTypeRw").className=="")
        {
            if(document.getElementById("RptTypRbl_0").checked==false && document.getElementById("RptTypRbl_1").checked==false)
            {
                args.IsValid=false;
                Page_IsValid=false;
            }
    ...
    function ChkValidationForFreq(src,args)
    {
        if(document.getElementById("RptTypRbl_1").checked==true)
        {
    ...
    function ChkValidationForRevReq(src,args)
    {
    
       if(document.getElementById("RevReqTr").className=="")
        {
    ...
    function ChkValidationForUgp(src,args)
    {
        if(document.getElementById("RptTypRbl_1").checked==true)
        {
            if(document.getElementById("UgpIdTxt").value=="")
            {
                args.IsValid=false;
                Page_IsValid=false;
            }
...
<!--
    ...
    function FnShowHide1()
    {
        ...
        if(document.getElementById("RptTypRbl_1").checked==true)
        {
            ...
            for(var i=0; i<Cnt; i++)
            {
                if(document.getElementById("FilTypeDDl_" + i)!=null)
                {
                    document.getElementById("FilTypeDDl_" + i).value=2
                }
                
                if(document.getElementById("DateDDL_" + i)!=null)
                {
                    document.getElementById("DateDDL_" + i).className=""
                    document.getElementById("DateDllTd_" + i).className="MainTD"
                    document.getElementById("CalDateDllTd_" + i).className="HideRow"
                }
            }
        }
        else
        {
            ...
            for(var i=0; i<Cnt; i++)
            {
                if(document.getElementById("FilTypeDDl_" + i)!=null)
                {
                    document.getElementById("FilTypeDDl_" + i).value=""
                }
                
                if(document.getElementById("DateDDL_" + i)!=null)
                {
                    document.getElementById("DateDDL_" + i).className="HideRow"
                    document.getElementById("DateDllTd_" + i).className="HideRow"
                    document.getElementById("CalDateDllTd_" + i).className="MainTD"
                }
            }
        }
    }
