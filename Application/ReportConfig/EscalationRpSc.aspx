<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EscalationRpSc.aspx.vb" Inherits="ReportConfig.EscalationRpSc" %>
...
<body>
    ...
    <script language="javascript">
        ...
        function fnChangeStatus(StsVal,cnt,baseid)
        {
            var xmlHttp;
            try 
            {    
            ...
            if (xmlHttp!=null)
            {
                xmlHttp.onreadystatechange=function()
                {
                    ...
                    {  
                        ...
                        if(s=="1")
                        {
                           document.getElementById("Sts_" + cnt).innerHTML="Active";
                           document.getElementById("Sts_" + cnt).style.color="Green";
                           document.getElementById("StsVal_" + cnt).innerHTML=1;
                        }
                        else if(s=="2")
                        {  
                           document.getElementById("Sts_" + cnt).innerHTML="In-Active";  
                           document.getElementById("Sts_" + cnt).style.color="Red"; 
                           document.getElementById("StsVal_" + cnt).innerHTML=2;                       
                        }
                        else
                        {
                            alert('Failed');
            ...
            if(document.getElementById("StsVal_" + cnt).innerHTML==1)
            {
                stsval=2;
            }
            else
            ...
            var url="EscalationSc_Ajax.aspx?baseid=" + baseid + "&StsVal=" + stsval;
