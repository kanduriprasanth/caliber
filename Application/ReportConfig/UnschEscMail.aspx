<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UnschEscMail.aspx.vb" Inherits="ReportConfig.UnschEscMail" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function FnOpenPreview(id)
        {
            pageURL ="EscPreview.aspx?Id=" + id
            SpWinObj = window.open(pageURL,'TemplatePreview',"height=700,width=900,toolbar=no,resizable=false,menubar=no,status=no,scrollbars=yes,top=75,left=75");
...
<body>
    ...
    <script language="javascript">
        ...
        {debugger
            ...
            var stsval=0;
            var url="EscalationSc_Ajax.aspx?baseid=" + baseid + "&StsVal=" + stsval + "&IsMailSend=" + 1;
