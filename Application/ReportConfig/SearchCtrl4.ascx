<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl4.ascx.vb"
    Inherits="ReportConfig.SearchCtrl4"  %>
...
<table class="SubTable" id="Table1" style="width: 100%" cellspacing="1" cellpadding="0"
    ...
    <tr>
        <td class="SubHeadTD" colspan="2" align="left">
            ...
            <select id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
                ...
                <option value="3">Escalation Level</option>
            </select>
        </td>
    </tr>
    <tr class="HideRow" id="SrchTr2">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                       Department Like &nbsp;<input class="TxtCls" id="SrchTxt2" style="width: 200px" accesskey="D"
                            type="text" maxlength="25" value='%' name="SrchTxt2"></td>
                </tr>
            </table>
        </td>
    </tr>
    <tr class="HideRow" id="SrchTr1">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                        &nbsp;Issue Category Like&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls" id="SrchTxt1"
                            style="width: 200px" value='%' accesskey="D" type="text" maxlength="30" name="SrchTxt1"></td>
                </tr>
            </table>
        </td>
    </tr>
    <tr class="HideRow" id="SrchTr3">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
                    <td class="MainTD">
                        Initiated Date Between&nbsp;&nbsp;&nbsp;&nbsp;<uc1:calibercalender id="FromDate"
                            runat="server"></uc1:calibercalender>
                        And
     ...
     <tr class="HideRow" id="SrchTr4">
        <td class="MainTd" colspan="2">
            <table class="SubTable" style="width: 100%" cellspacing="1" cellpadding="0" align="center"
                ...
                <tr>
               <td class="MainTD">
                &nbsp;Escalation Level =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input class="TxtCls" id="SrchTxt4"
                style="width: 200px" accesskey="D" type="text" maxlength="30" name="SrchTxt4"></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr class="HideRow">
        <td class="MainTd" colspan="2">
            <input type="hidden" value="SrchTxt1,SrchTxt2,SearchCtrl4<%=UniqeIDSep%>FromDate<%=UniqeIDSep%>CalDateVal,SearchCtrl4<%=UniqeIDSep%>ToDate<%=UniqeIDSep%>CalDateVal,SrchTxt4"
                name="SrchObjIds">
