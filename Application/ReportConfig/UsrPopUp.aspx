<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UsrPopUp.aspx.vb" Inherits="ReportConfig.UsrPopUp" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
	...
	{ 
        ...
        opener.FnAssignUsrVal(KdIdVal,KdDesVal,<%=icnt%>,<%=jcnt%>)
    }
	
	function fnCrCancel(){
		opener.FnAssignUsrVal('','','','')
		window.self.close()
	}
