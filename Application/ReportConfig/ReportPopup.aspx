<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportPopup.aspx.vb" Inherits="ReportConfig.ReportPopup" %>
...
<HTML>
	...
	{ 
		     ...
		     var KfIdVal=document.all("RptId"+ RowCnt).innerText
...
//		     var NameLableVal = document.all("NameLable"+ RowCnt).innerHTML
		     document.getElementById("KdIdVal").value = KfLableVal	
		   	opener.fnCrSetRptCode(KfIdVal,KfLableVal)
	}
	function fnCrCancel(){
		opener.fnCrSetRptCode('','')
		window.self.close()
