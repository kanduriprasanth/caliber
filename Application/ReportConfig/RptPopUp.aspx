<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RptPopUp.aspx.vb" Inherits="ReportConfig.RptPopUp" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
		<form id="Form1" method="post" runat="server">
			<TABLE class="MainTable" height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center"
				...
				<!-- MAIN HEADER -->
				<TR>
					<TD class="MainHead">Equipment List</TD>
				</TR>
				<TR>
					<TD>
	...
	{ 
		     var KfLableVal=document.all("NameLable"+ RowCnt).innerHTML
		     var KfIdVal=document.all("CatId"+ RowCnt).innerText
//		     var NameIdVal = document.all("NameId"+ RowCnt).innerText
//		     var NameLableVal = document.all("NameLable"+ RowCnt).innerHTML
		     document.getElementById("KdIdVal").value = KfLableVal	
		   	opener.fnCrSetToCode(KfLableVal,KfIdVal)
	}
	function fnCrCancel(){
