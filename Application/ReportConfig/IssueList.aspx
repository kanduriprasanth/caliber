<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IssueList.aspx.vb" Inherits="ReportConfig.IssueList" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function FnCheckValue()
        {
            ...
            {
                if(document.getElementById("SelChk" + i).checked==true)
                {
                    IssueAulIdTxt += ',' + document.getElementById("IssueAulId" + i).innerText;
                    IssueIdTxt += ',' + document.getElementById("IssueId" + i).innerText;
                }
            }
            
            document.getElementById("IssueAulIdTxt").value=IssueAulIdTxt;
            document.getElementById("IssueIdTxt").value=IssueIdTxt;
        }
        
        
        function FnSubmitRecord(IssueId,IssueAulId)
        {
            var xmlHttp;
            try 
            {    
            ...
            if (xmlHttp!=null)
            {
                xmlHttp.onreadystatechange=function()
                {
                    ...
                    {  
                        ...
                        {
                           alert('Report configuration is not done')                                
                        }
            ...
            var url="RecordSubmit_Ajax.aspx?IssueId=" + IssueId + "&IssueAulId=" + IssueAulId;
                    ...
                    <asp:Table runat="server" Width="100%" CellPadding="0" CellSpacing="0" HorizontalAlign="center"
                        ...
                        <asp:TableRow>
                            <asp:TableCell ColumnSpan="2" HorizontalAlign="Right">
                                <asp:Button ID="BtnConferm" runat="server" Width="200px" onMouseOver="this.className='ButSelOCls'"
                                    Class='HideRow' AccessKey="C" Text="Push Record To Report Table" onMouseOut="this.className='ButSelCls'"></asp:Button>
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                </asp:TableCell>
