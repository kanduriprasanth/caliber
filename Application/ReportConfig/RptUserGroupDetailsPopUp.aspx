<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RptUserGroupDetailsPopUp.aspx.vb" Inherits="ReportConfig.RptUserGroupDetailsPopUp" %>
                        ...
                        <tr>
                            ...
                            <td class="MainTd" colspan="3">
                                <asp:RadioButtonList ID="SearchOptionRD" runat="server" RepeatDirection="Horizontal"
                                    ...
                                    <asp:ListItem Value="1">Unique Code</asp:ListItem>
