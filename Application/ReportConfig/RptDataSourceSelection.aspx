<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RptDataSourceSelection.aspx.vb" Inherits="ReportConfig.RptDataSourceSelection" %>
...
<body>
            ...
            <asp:TableRow CssClass="HideRow" Height="0">
                <asp:TableCell ID="TableCell1" ColumnSpan="2">
                    ...
                    <asp:TextBox runat="server" ID="WorktemIdList"></asp:TextBox>
                     <asp:TextBox runat="server" ID="EformModuleType"></asp:TextBox>
    ...
    function fnCheckAll()
    {
          ...
          if(isAllChk==true) 
            {
                ...
                if (FormType==1) {
                  ...
                  AcpEFormID=AcpEFormID + ',' + document.getElementById ("FormId"+i).value
                  document.getElementById ("EformModuleType").value = document.getElementById ("Mod_"+i).value
                 } 
        ...
        if(FormType=="")
        {
            ...
            document.getElementById("ACPEFormIdTxt").value=''
        }
        ...
        else
        {
            ...
            document.getElementById("ACPEFormIdTxt").value=AcpEFormID.substring(1,AcpEFormID.length)
        }
	     
    }
    

    function fncheck(RowCnt,ISRadio)
    {
        ...
        selFormType=document.getElementById ("FormType"+RowCnt).value
         
        for(var i=1;i<=GlbCnt;i++)
        {
           FormType=document.getElementById ("FormType"+i).value
          
            if (ISRadio == 1  && FormType==selFormType && i!=RowCnt)
            { 
    ...
    function validateListSel(src,args)
    {
        ...
        else if (document.getElementById ("IsuFormIdTxt").value=="")
        {
            src.errormessage="Must Select At Least One Issue Form" ;
            args.IsValid=false;
            Page_IsValid=false;
        }
