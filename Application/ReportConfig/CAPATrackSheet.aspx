<%@ Page Language="vb" AutoEventWireup="false" EnableViewState="true" Codebehind="CAPATrackSheet.aspx.vb"
    Inherits="ReportConfig.CAPATrackSheet" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Table CellPadding="0" CellSpacing="0" BorderWidth="3" HorizontalAlign="center"
            ...
            <asp:TableRow ID="DevCtrlTabTR">
                <asp:TableCell ColumnSpan="6">
                    <asp:Table ID="DevCtrlTable" Width="100%" runat="server" HorizontalAlign="center"
                        CellPadding="0" CssClass="SubTable" CellSpacing="1">
                    </asp:Table>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow CssClass="HideRow">
                <asp:TableCell ID="HeadetrDiv" ColumnSpan="6">
                    <asp:Table ID="H1" runat="server" BorderWidth="0" CellSpacing="1" CellPadding="1"
                        Width="100%">
                        <asp:TableRow>
                            <asp:TableCell ColumnSpan="2" HorizontalAlign="left" runat="server"><b><br><%=replace(Session("CompanyAddr"),vbcrlf, "<BR>")%></b></asp:TableCell>
                            <asp:TableCell ColumnSpan="2" HorizontalAlign="Center" runat="server"><b><br /><%=ActionPlanReport%></b></asp:TableCell>
                            <asp:TableCell ColumnSpan="2" CssClass="MainTd" runat="server" HorizontalAlign="right"><img src="../IMAGES/CompanyLogo.jpg"></asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                </asp:TableCell>
            </asp:TableRow>
