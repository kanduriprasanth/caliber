<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ESCCodeAudit.aspx.vb"
    Inherits="ReportConfig.ESCCodeAudit" %>
...
<head>
   ...
   {
        var pageURL = "../IssueLogin/ESCCodeAudit.aspx?BaseID="+ BaseID  + "&AuditType=" + AuditType + "&HisID=" + HisID + "&NextHisId=" + NextHisId
