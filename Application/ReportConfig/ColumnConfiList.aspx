<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ColumnConfiList.aspx.vb" Inherits="ReportConfig.ColumnConfiList" %>
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Table ID="CrTopTable" runat="server" HorizontalAlign="center" CellPadding="0"
                        ...
                        <asp:TableRow ID="FilterTr" runat="server" CssClass="MainTD" >
                        ...
                        <asp:TableRow>
                            <asp:TableCell CssClass="MainTD">
                                <asp:Table ID="IssueTab" CssClass="ReportSubTable" runat="server" Width="100%" BorderWidth="1"
...
<!--
        ...
        function System_Fld_Popup(RowCnt, ControlId, DataType, ObjectType) {
            ...
            function fnOpenPage(InputValue, SrcType) {
                ...
                url: "Proxy_Ajax.aspx",
                data:"InputValue=" +  InputValue  +  "&SrcType=" + SrcType  + "&UserID=" + UserID + "&PlantCode=" + PlantCode ,
        ...
        var ProxyWinObj = null
            function OpenCommonPopup(Guid) {
                    ...
                    var pageURL = 'ReportProxy.aspx?Uid=' + UserID + '&PC=' + PC + '&Skey=' + Guid  + "&ISCOlCfgList=1"
