<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RptUParticulars.aspx.vb" Inherits="Admin.RptUParticulars" %>
									...
									<ASP:DATAGRID CssClass="SubTable" id="DataGrid1" CellPadding="0" CellSpacing="1" BorderWidth="0"
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="User Name">
												<ItemTemplate>
													<asp:HyperLink id="Hyperlink1" Runat=server NavigateUrl='<%# "RptUParticularsAudit.aspx?UserID=" &amp; DataBinder.Eval(Container, "DataItem.UserID")%>' text='<%# DataBinder.Eval(Container, "DataItem.UserName") %>'>
													</asp:HyperLink>
												</ItemTemplate>
											</asp:TemplateColumn>
