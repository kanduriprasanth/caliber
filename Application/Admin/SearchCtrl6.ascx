...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl6.ascx.vb" Inherits="Admin.SearchCtrl6"  %>
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
				...
				<option value="2"> Profile Set By </option>
				<option value="3"> Role  </option>
				<option value="4"> Profile Set On  </option>
			</SELECT>
		</td>
	</tr>
