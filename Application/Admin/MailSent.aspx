<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MailSent.aspx.vb" Inherits="Admin.MailSent" %>
	...
	<body MS_POSITIONING="GridLayout" bottommargin="0" rightmargin="0">
		<form id="f1" name="f1" method="post" runat="server">
			...
			<TABLE class="MainTable" height="400" cellSpacing="0" cellPadding="0" width="720" align="center"
				...
				<!-- MAIN HEADER -->
				<TR>
					<TD class="MainHead" colspan="2">Caliber Mail - Sent Mails</TD>
				</TR>
				<TR>
							...
							<TR>
								<TD class="MainTD" style="FONT-SIZE:10pt;PADDING-TOP:5px">
									<asp:Label Runat="server" ID="Label5">
										<B>Sent Mails from</B></asp:Label>
									<asp:Label Runat="server" ID="lblSentFrom"></asp:Label></TD>
							</TR>
							<TR>
								<TD class="MainTD" style="PADDING-TOP:3px">
									<asp:Label Runat="server" ID="Label1">Total Messages Sent <b>:</b></asp:Label>
									...
									<asp:DataGrid id="Datagrid1" CssClass="SubTable" CellPadding="0" CellSpacing="1" BorderWidth="0"
										...
										<Columns>
											<asp:TemplateColumn HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="MainTD" HeaderText=" " ItemStyle-Width="20"
												...
												<ItemTemplate>
													<%# fnGetCheckBox(DataBinder.Eval(Container, "DataItem.AD_IM_ID"))%>
													</asp:CheckBox>&nbsp;
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="MainTD" HeaderText="Sent To">
												<ItemTemplate>
													<asp:HyperLink id="Hyperlink1" Runat=server NavigateUrl='<%# "MailSentView.aspx?IMID=" &amp; DataBinder.Eval(Container, "DataItem.AD_IM_ID")%>' text='<%# DataBinder.Eval(Container, "DataItem.ToUsers") %>'>
													</asp:HyperLink>
												</ItemTemplate>
											</asp:TemplateColumn>
											...
											<asp:TemplateColumn HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="MainTD" HeaderText="Sent On"
												ItemStyle-Width="135">
												<ItemTemplate>
