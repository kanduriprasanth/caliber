<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RptGProfileAuditDiff.aspx.vb" Inherits="Admin.RptGProfileAuditDiff" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
  <head>
    <title>RptGProfileAuditDiff</title>
	...
	<STYLE>
	.ACss1{Height:100%;Padding:2px;Padding-Left:5px;Padding-Right:5px;Text-align:center;Text-Decoration:none;Border-Width:1px;Background-image:url(IMAGES/menu_strip_bg_gray.gif);Color:black;}
	.ACss2{Height:100%;Padding:2px;Padding-Left:5px;Padding-Right:5px;Text-align:center;Text-Decoration:none;Border-Width:1px;Background-image:url(IMAGES/bg_menu1.gif) ;Color:yellow;}
	</STYLE>
  </head>
