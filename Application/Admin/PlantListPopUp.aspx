<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PlantListPopUp.aspx.vb" Inherits="Admin.PlantListPopUp" %>
...
<HTML>
							...
							<table width="100%" cellSpacing="0" cellPadding="0" align="center">
								...
								<tr>
									<td class="MainTd" colspan="2">
										...
										<asp:TextBox id="FindTxt" runat="server" Width="100px" CssClass='TxtCls'>%</asp:TextBox>
									</td>
									<td class="MainTd" colspan="2">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=Radio name=RB  value="AllAnalysts"   onClick='fnCrGetCode1()' style='height:15px;width:15px;' ID='RBID0' > <span id='KfLable0'>All Plants</Span>
								</td>
								</tr>
								<tr>
								<tr>
 ...
 var KfCheck=false
    ...
    var KfLableVal=document.all("KfLable_1"+ RowCnt).innerHTML
