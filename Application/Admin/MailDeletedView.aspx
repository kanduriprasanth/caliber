<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MailDeletedView.aspx.vb" Inherits="Admin.MailDeletedView" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" bottommargin=0 rightmargin=0>
		<form id="f1" name="f1" method="post" runat="server">
			...
			<!-- MAIN HEADER -->
			<TR><TD class="MainHead" colspan=2>Caliber Mail - Deleted Message View</TD></TR>
			<TR><TD style="Padding-Right:0px;Width:120px;" valign=top>
						...
						<TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" style="border-style:groove;border-width:2px;">
							...
							<asp:Label Runat=server ID="Label5"><B>Message for</b> <asp:Label Runat=server ID="lblMessageFor"></asp:Label></asp:Label></TD></TR>
						</TABLE>
						
						<TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" style="border-style:groove;border-width:2px;">	
							<TR><TD class="MainTD" style="Padding-Top:2px;Width:80px" valign=top>
								<asp:Label Runat=server ID="Label1" Width=75>From</asp:Label><b>:</b></TD>
								<TD class="MainTD" style="Padding-Top:2px;" valign=top>
								<asp:Label Runat=server ID="lblFrom"></asp:Label></TD></TR>
							...
							<TR><TD class="MainTD" style="Padding-Top:2px;" valign=top>
								...
								<TD class="MainTD" style="Padding-Top:2px;" valign=top>
								<asp:Label Runat=server ID="lblRecivedOn"></asp:Label></TD></TR>
						</TABLE>
