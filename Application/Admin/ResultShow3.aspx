<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ResultShow3.aspx.vb" Inherits="Admin.ResultShow3" %>
					...
					<TR>
						<TD style="FONT-SIZE:10pt; FONT-FAMILY:Ms Serif" vAlign="middle">&nbsp;
							<TABLE border="0" class="MainTable"  bordercolor="white" cellSpacing="0" cellPadding="0" Height="160" width="500"
								...
								<TR height="20" style="width:'90%'; background-image:url(IMAGES/top_bg.gif)">
								...
								<TR style="background-image:url(IMAGES/bg_greygradient1.gif)">
								...
								<TR height="20px" style="BACKGROUND-COLOR:#ffffff" style=" background-image:url(IMAGES/top_bg.gif)">
