<%@ Page Language="vb" AutoEventWireup="false" Codebehind="UserStatusReport.aspx.vb" Inherits="Admin.UserStatusReport"%>
			...
			<form id="Form1" method="post" runat="server">
				<asp:Panel id="HeaderDiv" runat="server" Width="720" HorizontalAlign="Left" EnableViewState="False">
					<SPAN style="TEXT-ALIGN: center">
						<uc2:ReportHeader id="ReportHeader1" runat="server"></uc2:ReportHeader></SPAN>
				</asp:Panel>
