<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RptEPSWAttempts.aspx.vb" Inherits="Admin.RptEPSWAttempts" %>
...
<HTML>
  <HEAD>
	...
	<BODY MS_POSITIONING="GridLayout">
		...
		<TABLE class="MainTable" height="100" cellSpacing="0" cellPadding="0" width="550" align="center" border="0">
		<!-- MAIN HEADER -->
		...
		<TR><TD>
				...
				<TR><TD>
						...
						<COLUMNS>
							...
							<ITEMTEMPLATE><ASP:LABEL id="Label4" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.IPAddress") %>'></ASP:LABEL></ITEMTEMPLATE>							
							</ASP:TEMPLATECOLUMN>								
							
							<ASP:TEMPLATECOLUMN HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="Date & Time" ItemStyle-Width="135">
							<ITEMTEMPLATE><ASP:LABEL id="Label2" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.AttemptedOn") %>'></ASP:LABEL></ITEMTEMPLATE>
							</ASP:TEMPLATECOLUMN>
							
							<ASP:TEMPLATECOLUMN HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="Attempts" ItemStyle-Width="60">
							<ITEMTEMPLATE><ASP:LABEL id="Label5" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.AttemptsNo")%>'></ASP:LABEL></ITEMTEMPLATE>
							</ASP:TEMPLATECOLUMN>
						</COLUMNS>
						</ASP:DATAGRID>
				</TD></TR>
