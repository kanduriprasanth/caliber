...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl4.ascx.vb" Inherits="Admin.SearchCtrl4"  %>
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<asp:ListItem Value="0" Text="" selected>Top 250 Records</asp:ListItem>
		<asp:ListItem Value="2" Text=" User Name "></asp:ListItem>
		<asp:ListItem Value="3" Text=" IPAddress "></asp:ListItem>
		<asp:ListItem Value="4" Text=" Date & Time "></asp:ListItem>
		</asp:DropDownList>
		</td>
	</tr>
...
function HideAllSrchTypes(){
    ...
    var ObjId
    for(i=1;i<SrchCnt;i++){
     ObjId="SrchTr" + document.getElementById("<%=Me.ClientID & Me.ClientIDSeparator%>SearchTypeDD")(i).value //i
