<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RptUProfile.aspx.vb" Inherits="Admin.RptUProfile" %>
				...
				<TR>
					<TD>
						<TABLE class="SubTable" cellSpacing="0" cellPadding="0" width="100%" align="center">
							...
							<TR>
								<TD><asp:table id="Table2" runat="server" HorizontalAlign="center" cellspacing="1" CELLPADDING="1"
									...
									<ASP:DATAGRID CssClass="SubTable" id="DataGrid1" CellPadding="0" CellSpacing="1" BorderWidth="0"
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="User Name">
												<ItemTemplate>
													<asp:HyperLink id="Hyperlink1" Runat=server NavigateUrl='<%# "RptUProfileAudit.aspx?UProfileID=" &amp; DataBinder.Eval(Container, "DataItem.UProfileID")%>' text='<%# DataBinder.Eval(Container, "DataItem.UserName") %>'>
													</asp:HyperLink>
												</ItemTemplate>
											</asp:TemplateColumn>
											...
											<asp:TemplateColumn HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="Category">
												<ItemTemplate>
													<asp:Label id="Label10" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CategoryName") %>'>
													</asp:Label>
												</ItemTemplate>
											</asp:TemplateColumn>
											...
											<asp:TemplateColumn HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="Profile Set On">
												<ItemTemplate>
													<asp:Label id="Label1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.InitiatedOn") %>'>
													</asp:Label>
												</ItemTemplate>
											</asp:TemplateColumn>
										</Columns>
