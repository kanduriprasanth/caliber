<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LanguageAudit.aspx.vb" Inherits="Admin.LanguageAudit" %>
<%@ Register TagPrefix="uc1" TagName="SearchCtrl8" Src="SearchCtrl8.ascx" %>
						...
						<ASP:TABLE id="CrTopTable" runat="server" HorizontalAlign="center" CELLPADDING="0" CSSClass="SubTable"
							...
							<asp:TableRow>
								<asp:TableCell CSSClass="MainTD" ColumnSpan="6">
									<uc1:SearchCtrl8 id="SearchCtrl8" runat="server"></uc1:SearchCtrl8>
								</asp:TableCell>
							</asp:TableRow>
							...
							<ASP:TABLEROW>
								...
								<ASP:TABLECELL CssClass="MainTD">
									<ASP:TEXTBOX id="RecPerPageTxt" CssClass="TxtCls" Runat="server" AutoPostBack="False" Width="50px">20</ASP:TEXTBOX>
								</ASP:TABLECELL>
								<ASP:TABLECELL CssClass="MainTD">
