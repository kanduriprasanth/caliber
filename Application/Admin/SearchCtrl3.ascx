...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl3.ascx.vb" Inherits="Admin.SearchCtrl3"  %>
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
				...
				<option value="3"> Reset By  </option>
				<option value="4"> Requested On </option>
			</SELECT>
		</td>
	</tr>
