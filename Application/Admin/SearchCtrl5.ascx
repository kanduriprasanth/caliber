...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchCtrl5.ascx.vb" Inherits="Admin.SearchCtrl5"  %>
<table class="SubTable" id="Table1" style="WIDTH: 100%" cellSpacing="1" cellPadding="0"
	...
	<tr>
		...
		<SELECT id="SearchTypeDD" onchange="DisplayFilterTab()" name="SearchTypeDD">
				...
				<option value="2"> Revised By </option>
				<option value="3"> Revised Status  </option>
				<option value="4"> Revised On  </option>
			</SELECT>
		</td>
	</tr>
