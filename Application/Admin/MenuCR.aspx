<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MenuCR.aspx.vb" Inherits="Admin.MenuCR" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE WIDTH="700" Height="200" class="MainTable" ALIGN="center" BORDER="0" CELLSPACING="0"
				...
				<!-- MAIN HEADER -->
				<TR>
					<TD class="MainHead">New Menu Registration</TD>
				</TR>
				<!-- MAIN BODY -->
				<TR>
					<TD>
						<TABLE WIDTH="100%" class="SubTable" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0"
							...
							<TR>
								<TD class="MainTD">
									<asp:Label Runat="server" id="Label8" style="PADDING-LEFT:5px" Width="100">Module Name</asp:Label>
							...
							<TR>
								<TD class="MainTD" style="PADDING-TOP:5px">
									<asp:Label Runat="server" id="Label1" style="PADDING-LEFT:5px" Width="100">No. Of Menus</asp:Label>
								...
								<TD class="MainTD" style="PADDING-RIGHT:5px;PADDING-LEFT:5px;PADDING-BOTTOM:5px;PADDING-TOP:5px">
									<asp:Table Runat="server" ID="MenuTable" Width="100%" CellPadding="0" CellSpacing="1" BorderWidth="0"
										...
										<asp:TableRow CssClass="MainTD">
											...
											<asp:TableCell style="Border-style:groove;border-width:2px;">Is Parent</asp:TableCell>
										</asp:TableRow>
									</asp:Table>
								</TD>
							</TR>
									...
									<asp:DataGrid CssClass="SubTable" id="DGridMenus" CellPadding="0" CellSpacing="1" BorderWidth="0"
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="Menu Name">
												<ItemTemplate>
													<asp:Label id="Label4" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.AD_MEN_DESC") %>'>
													</asp:Label>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="Menu Code"
												ItemStyle-Width="80">
												<ItemTemplate>
													<asp:Label id="Label13" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.AD_MEN_CODE") %>'>
													</asp:Label>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="Menu Path">
												<ItemTemplate>
													<asp:Label id="Label9" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.AD_MEN_ACT_PATH") %>'>
													</asp:Label>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="Seq. NO" ItemStyle-Width="80">
												<ItemTemplate>
													<asp:Label id="Label5" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.AD_MEN_SEQ_NUM") %>'>
													</asp:Label>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="Is Parent"
												ItemStyle-Width="80">
												<ItemTemplate>
													<asp:Label id="Label2" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.AD_MEN_ISPARENT") %>'>
													</asp:Label>
												</ItemTemplate>
											</asp:TemplateColumn>
