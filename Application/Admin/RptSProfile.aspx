<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RptSProfile.aspx.vb" Inherits="Admin.RptSProfile" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>RptSProfile</title>
		...
		function chk()
		{
			...
			for(i=0;i<len;i++)
			{
				...
				if(cnt==3)
				{
					...
					//	if(document.all("ChkDiff")(i).checked)
					//	{
					//		document.all("ChkDiff")(i).checked=false
					//		return
					//	}
					//}
									...
									<DIV valign="top" STYLE="DISPLAY:block;OVERFLOW:scroll;HEIGHT:300px">
										<asp:DataGrid CssClass="SubTable" id="Datagrid1" CellPadding="0" CellSpacing="1" BorderWidth="0"
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderStyle-CssClass="HeadTD" ItemStyle-CssClass="MainTD" HeaderText="Version No(s)"
													ItemStyle-Width="80" ItemStyle-HorizontalAlign="Center">
													<ItemTemplate>
														<asp:Label id="Label9" runat="server" Text='<%# GetCheckbox(DataBinder.Eval(Container, "DataItem.SProfileID")) %>'>
														</asp:Label>
													</ItemTemplate>
												</asp:TemplateColumn>
											</Columns>
