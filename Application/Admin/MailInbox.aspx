<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MailInbox.aspx.vb" Inherits="Admin.MailInbox" %>
	...
	<body MS_POSITIONING="GridLayout" bottommargin="0" rightmargin="0">
		<form id="f1" name="f1" method="post" runat="server">
			...
			<TABLE class="MainTable" height="400" cellSpacing="0" cellPadding="0" width="720" align="center"
				...
				<!-- MAIN HEADER -->
				<TR>
					<TD class="MainHead" colspan="2">Caliber Mail - Inbox</TD>
				</TR>
				<TR>
					...
					<TD valign="top"> <!--''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''-->
						<TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" style="BORDER-RIGHT:2px groove;BORDER-TOP:2px groove;BORDER-LEFT:2px groove;BORDER-BOTTOM:2px groove">
							<TR>
								<TD class="MainTD" style="FONT-SIZE:10pt;PADDING-TOP:5px">
									<asp:Label Runat="server" ID="Label5">
										<B>Inbox for</B></asp:Label>
									<asp:Label Runat="server" ID="lblInboxFor"></asp:Label></TD>
							</TR>
							<TR>
							...
							<TR>
								<TD class="MainTD" style="PADDING-TOP:2px">
									<asp:Label Runat="server" ID="Label2">New Messages <b>:</b></asp:Label>
									<asp:Label Runat="server" ID="lblNewMsgs"></asp:Label></TD>
							</TR>
						</TABLE>
						<TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" style="BORDER-RIGHT:2px groove;BORDER-TOP:2px groove;BORDER-LEFT:2px groove;BORDER-BOTTOM:2px groove">
							<TR>
									...
									<asp:DataGrid id="Datagrid1" CssClass="SubTable" CellPadding="0" CellSpacing="1" BorderWidth="0"
										...
										<Columns>
											<asp:TemplateColumn HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="MainTD" HeaderText=" " ItemStyle-Width="20"
												...
												<ItemTemplate>
													<%# fnGetCheckBox(DataBinder.Eval(Container, "DataItem.AD_IUM_ID"), DataBinder.Eval(Container, "DataItem.Flag"))%>
													</asp:CheckBox>&nbsp;
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="MainTD" HeaderText="Sent From">
												<ItemTemplate>
													<asp:HyperLink id="Hyperlink1" Runat=server NavigateUrl='<%# "MailView.aspx?IUMID=" &amp; DataBinder.Eval(Container, "DataItem.AD_IUM_ID")%>' text='<%# DataBinder.Eval(Container, "DataItem.SentFrom") %>'>
													</asp:HyperLink>
												</ItemTemplate>
											</asp:TemplateColumn>
											...
											<asp:TemplateColumn HeaderStyle-CssClass="SubHead" ItemStyle-CssClass="MainTD" HeaderText="Received On"
												ItemStyle-Width="135">
												<ItemTemplate>
