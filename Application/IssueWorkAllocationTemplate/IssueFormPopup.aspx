<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IssueFormPopup.aspx.vb" Inherits="IssueWorkAllocationTemplate.IssueFormPopup" %>
...
<body ms_positioning="GridLayout" onload="document.getElementById('FindTxt').focus()" onblur="document.getElementById('FindTxt').focus()">
	...
	{ 
		...
		var KdCodeVal=document.all("KdDes"+ RowCnt).innerText
		document.getElementById("RBVal").value = KdIdVal
				
		opener.GetFormVals(KdIdVal,KdCodeVal,KfLableVal)
	}
	function fnCrCancel(){
		opener.GetFormVals('','','')
		window.self.close()
